...
msg_double={
    ...
    'tt-cyrl': u'Робот: икеле күчешне дөресләү → %(to)s',
...
reason_broken={
    ...
    'tt-cyrl': u'[[ВП:ТБК#П1|П1]]: беркаяда күчеш ясамау',
...
reason_loop={
    ...
    'tt-cyrl': u'[[ВП:ТБК#П1|тиз бетерү критерийлары ''П.1'']] — беркаяда күчеш ясамау',
