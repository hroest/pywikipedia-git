...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ml', 'ja', 'ku', 'es', 'ar', 'et', 'ro', 'id', 'te', 'li', 'gl',
            'uk', 'bg', 'ca', 'vo', 'fa', 'is', 'scn', 'sr', 'af', 'cs',
            'simple', 'th', 'fy', 'sw', 'oc', 'hr', 'br', 'he', 'mg', 'sl',
            'la', 'hy', 'sq', 'tt', 'zh-min-nan', 'da', 'wa', 'ne', 'my', 'tk',
            'ast', 'ur', 'hsb', 'kk', 'ky', 'eo', 'lv', 'cy', 'wo', 'ka', 'ang',
            'co', 'hi', 'ga', 'gn', 'az', 'ia', 'eu', 'sk', 'ms', 'csb', 'st',
            'tl', 'mr', 'be', 'nds', 'kl', 'sd', 'ug', 'ps', 'ti', 'mk', 'sh',
            'an', 'bn', 'gu', 'km', 'ss', 'qu', 'ts', 'bs', 'fo', 'am', 'si',
            'rw', 'chr', 'su', 'om', 'iu', 'mn', 'nah', 'yi', 'ie', 'gv', 'kw',
            'mt', 'tg', 'gd', 'nn', 'zu', 'pa', 'dv', 'tpi', 'ik', 'sg',
