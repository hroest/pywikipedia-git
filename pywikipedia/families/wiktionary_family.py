...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            'en', 'fr', 'zh', 'lt', 'mg', 'ru', 'tr', 'pl', 'vi', 'ta', 'ko',
            'io', 'de', 'hu', 'pt', 'fi', 'el', 'sv', 'no', 'nl', 'my', 'it',
            'kn', 'et', 'li', 'ml', 'fa', 'ja', 'lo', 'es', 'ku', 'ar', 'ro',
            'te', 'hi', 'id', 'gl', 'ca', 'uk', 'cs', 'bg', 'eo', 'vo', 'is',
            'hr', 'oc', 'simple', 'scn', 'th', 'sr', 'af', 'br', 'fy', 'sw',
            'eu', 'he', 'cy', 'la', 'sq', 'sl', 'hy', 'da', 'tt', 'wa',
            'zh-min-nan', 'az', 'ne', 'lv', 'ka', 'tk', 'ast', 'ur', 'hsb',
            'kk', 'nn', 'ky', 'wo', 'km', 'ang', 'ps', 'be', 'co', 'ga', 'mr',
            'gn', 'ia', 'sk', 'tl', 'csb', 'ms', 'st', 'bs', 'nds', 'sd', 'kl',
            'sh', 'si', 'ug', 'ti', 'mk', 'lb', 'bn', 'an', 'nah', 'zu', 'gu',
            'tg', 'am', 'ss', 'qu', 'chr', 'ts', 'fo', 'rw', 'om', 'kw', 'gv',
