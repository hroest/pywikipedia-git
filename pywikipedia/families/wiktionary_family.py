...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'mg', 'uk', 'bg', 'ca', 'vo', 'fa', 'is', 'scn', 'sr', 'simple',
            'cs', 'af', 'hr', 'th', 'oc', 'fy', 'sw', 'br', 'my', 'he', 'la',
            'sq', 'sl', 'hy', 'tt', 'zh-min-nan', 'da', 'wa', 'ne', 'tk', 'cy',
            'ast', 'ur', 'hsb', 'lv', 'kk', 'ka', 'eo', 'ky', 'wo', 'ang', 'co',
            'hi', 'az', 'eu', 'ga', 'mr', 'gn', 'ia', 'sk', 'ms', 'csb', 'tl',
            'st', 'nn', 'be', 'nds', 'kl', 'sd', 'ug', 'ps', 'ti', 'mk', 'sh',
            'bn', 'an', 'gu', 'si', 'km', 'ss', 'ts', 'qu', 'bs', 'fo', 'am',
            'rw', 'chr', 'zu', 'su', 'om', 'iu', 'mn', 'kw', 'nah', 'yi', 'ie',
            'gv', 'pa', 'mt', 'gd', 'tg', 'tpi', 'dv', 'lb', 'ik', 'za', 'sg',
