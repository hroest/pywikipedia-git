...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'lo', 'ml', 'ja', 'es', 'ku', 'ar', 'et', 'ro', 'id', 'my', 'te',
            'gl', 'mg', 'uk', 'bg', 'ca', 'vo', 'fa', 'is', 'scn', 'sr', 'cs',
            'simple', 'hr', 'af', 'th', 'oc', 'fy', 'sw', 'br', 'he', 'la',
            'sq', 'sl', 'hy', 'tt', 'zh-min-nan', 'da', 'wa', 'ne', 'cy', 'tk',
            'ast', 'lv', 'ur', 'hsb', 'kk', 'ka', 'eo', 'ky', 'wo', 'ang', 'co',
            'hi', 'az', 'mr', 'eu', 'ga', 'gn', 'ia', 'sk', 'ms', 'csb', 'tl',
            'st', 'nn', 'be', 'nds', 'kl', 'sd', 'ug', 'ps', 'ti', 'mk', 'sh',
            'bn', 'an', 'gu', 'si', 'km', 'zu', 'ss', 'qu', 'ts', 'bs', 'fo',
            'am', 'rw', 'chr', 'om', 'su', 'iu', 'kw', 'mn', 'nah', 'yi', 'ie',
            'gv', 'pa', 'mt', 'lb', 'gd', 'tg', 'tpi', 'dv', 'ik', 'za', 'sg',
            'so', 'roa-rup', 'jv', 'uz', 'ln', 'sm', 'mi', 'ha', 'ay', 'sa',
