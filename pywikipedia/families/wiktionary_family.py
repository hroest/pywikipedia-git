...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'de', 'io', 'el', 'kn', 'fi', 'hu', 'pt', 'nl', 'sv', 'no', 'it',
            ...
            'sl', 'wa', 'tt', 'zh-min-nan', 'az', 'ka', 'lv', 'ne', 'tk', 'lb',
            'ps', 'hsb', 'kk', 'nn', 'ky', 'wo', 'bs', 'km', 'be', 'ang', 'ga',
            'co', 'mr', 'gn', 'nah', 'ia', 'sk', 'csb', 'ms', 'st', 'pnb',
            'nds', 'sd', 'kl', 'sh', 'si', 'tg', 'ug', 'ti', 'mk', 'zu', 'bn',
            'an', 'gu', 'ss', 'qu', 'chr', 'am', 'ts', 'fo', 'rw', 'kw', 'om',
            'gv', 'iu', 'su', 'roa-rup', 'sa', 'mn', 'so', 'yi', 'ie', 'gd',
            'za', 'pa', 'mt', 'mi', 'tpi', 'dv', 'ik', 'sg', 'na', 'uz', 'ln',
            'jv', 'sm', 'tn', 'ha', 'ay', 'ks', 'jbo', 'dz',
        ]
