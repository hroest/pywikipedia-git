...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'no', 'ca', 'fi', 'uk', 'hu', 'cs', 'ro', 'tr', 'ko', 'da',
            'eo', 'ar', 'id', 'vi', 'vo', 'sr', 'sk', 'lt', 'he', 'bg', 'fa',
            'war', 'sl', 'hr', 'et', 'new', 'ms', 'simple', 'th', 'gl', 'nn',
            'roa-rup', 'eu', 'hi', 'el', 'ht', 'te', 'la', 'ka', 'mk', 'ceb',
            'az', 'br', 'sh', 'mr', 'tl', 'jv', 'lb', 'bs', 'is', 'lv', 'cy',
            'pms', 'sq', 'be-x-old', 'bpy', 'ta', 'oc', 'an', 'bn', 'be', 'io',
            'sw', 'fy', 'nds', 'scn', 'lmo', 'gu', 'af', 'qu', 'su', 'zh-yue',
            'ur', 'ast', 'ml', 'ku', 'nap', 'bat-smg', 'wa', 'cv', 'ga', 'ksh',
            'hy', 'yo', 'tg', 'kn', 'roa-tara', 'vec', 'gd', 'yi', 'uz', 'pam',
            'zh-min-nan', 'os', 'tt', 'sah', 'mi', 'als', 'arz', 'kk', 'ne',
            'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'pnb', 'ia', 'bcl', 'mn',
            'fiu-vro', 'am', 'nds-nl', 'fo', 'vls', 'tk', 'sa', 'si', 'bar',
            'dv', 'nrm', 'gv', 'pag', 'rm', 'map-bms', 'my', 'sco', 'diq', 'se',
            'wuu', 'fur', 'lij', 'fj', 'ug', 'bh', 'mt', 'nov', 'mzn', 'csb',
            'mg', 'ilo', 'km', 'zh-classical', 'lad', 'pi', 'sc', 'ang', 'frp',
            'hak', 'bo', 'hif', 'ckb', 'pa', 'kw', 'xal', 'szl', 'pdc', 'haw',
            'ps', 'cbk-zam', 'ie', 'stq', 'crh', 'kv', 'to', 'ace', 'myv', 'so',
            'gn', 'nv', 'krc', 'ky', 'ln', 'ext', 'mhr', 'arc', 'jbo', 'wo',
            'eml', 'pcd', 'kab', 'ty', 'tpi', 'pap', 'ay', 'zea', 'srn', 'ba',
            'kl', 'ce', 'ig', 'or', 'udm', 'dsb', 'kg', 'lo', 'rmy', 'ab', 'cu',
            'mwl', 'mdf', 'kaa', 'sm', 'av', 'ks', 'tet', 'got', 'sd', 'na',
            'bm', 'pih', 'pnt', 'iu', 'ik', 'cdo', 'as', 'bi', 'ee', 'chr',
            'bug', 'om', 'za', 'ti', 'ss', 'ts', 've', 'ha', 'zu', 'sg', 'dz',
            'ch', 'cr', 'xh', 'lbe', 'ak', 'rw', 'ki', 'tn', 'bxr', 'ny', 'st',
            'tw', 'rn', 'sn', 'chy', 'ff', 'lg', 'tum',
        ]
