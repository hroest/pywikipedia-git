...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'kk', 'arz', 'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'ia', 'mn',
            'bcl', 'am', 'fiu-vro', 'nds-nl', 'tk', 'fo', 'vls', 'si', 'sa',
            'bar', 'dv', 'gv', 'nrm', 'pag', 'rm', 'sco', 'my', 'map-bms',
            'diq', 'ckb', 'se', 'wuu', 'fur', 'mzn', 'ug', 'lij', 'mt', 'bh',
            ...
            've', 'zu', 'ha', 'dz', 'sg', 'ch', 'cr', 'ak', 'xh', 'rw', 'tn',
            'ki', 'bxr', 'ny', 'st', 'tw', 'lbe', 'sn', 'rn', 'chy', 'ff',
            'tum', 'lg',
        ]
