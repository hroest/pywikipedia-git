...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'mk', 'ceb', 'sh', 'br', 'pms', 'lv', 'mr', 'jv', 'be-x-old', 'lb',
            'sq', 'cy', 'is', 'bs', 'ta', 'be', 'bpy', 'an', 'oc', 'bn', 'io',
            'sw', 'lmo', 'fy', 'gu', 'af', 'nds', 'ml', 'ur', 'qu', 'scn', 'ku',
            'zh-yue', 'su', 'ast', 'nap', 'hy', 'bat-smg', 'yo', 'ga', 'cv',
            'wa', 'ne', 'pnb', 'kn', 'ksh', 'tg', 'roa-tara', 'vec', 'yi', 'gd',
            'als', 'zh-min-nan', 'os', 'uz', 'pam', 'sah', 'kk', 'tt', 'arz',
            'am', 'mi', 'li', 'nah', 'hsb', 'sco', 'gan', 'co', 'glk', 'mn',
            'ia', 'my', 'bcl', 'bug', 'fo', 'fiu-vro', 'nds-nl', 'si', 'vls',
            'tk', 'sa', 'bar', 'mg', 'gv', 'ilo', 'dv', 'nrm', 'pag', 'map-bms',
            'ckb', 'rm', 'diq', 'se', 'mzn', 'wuu', 'fur', 'ug', 'lij', 'mt',
            'bh', 'bo', 'nov', 'ang', 'csb', 'hif', 'sc', 'zh-classical', 'lad',
            'km', 'cbk-zam', 'pi', 'frp', 'ps', 'hak', 'kw', 'pa', 'nv', 'rue',
            'szl', 'xal', 'pdc', 'haw', 'stq', 'ie', 'so', 'udm', 'kv', 'to',
            'krc', 'rw', 'mhr', 'crh', 'ace', 'pcd', 'ln', 'myv', 'ext', 'gn',
            'ky', 'ce', 'eml', 'arc', 'ba', 'pap', 'mrj', 'ay', 'jbo', 'wo',
            'bjn', 'frr', 'kl', 'tpi', 'kab', 'ty', 'srn', 'zea', 'gag', 'ab',
            'koi', 'dsb', 'ig', 'or', 'lo', 'kg', 'mdf', 'av', 'mwl', 'rmy',
            'cu', 'kaa', 'sm', 'tet', 'lbe', 'got', 'ks', 'bm', 'ik', 'sd',
            'bi', 'na', 'as', 'pfl', 'pih', 'iu', 'pnt', 'ss', 'chr', 'cdo',
            'ha', 'ee', 'ti', 'om', 'zu', 'za', 've', 'ts', 'sg', 'rn', 'dz',
            'cr', 'ch', 'lg', 'tum', 'fj', 'bxr', 'ny', 'ak', 'st', 'xh', 'ff',
            'tn', 'ki', 'sn', 'tw', 'chy',
        ]
