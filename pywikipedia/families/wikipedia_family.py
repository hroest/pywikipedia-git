...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ro', 'fa', 'da', 'ar', 'eo', 'sr', 'lt', 'sk', 'he', 'ms', 'vo',
            'bg', 'sl', 'eu', 'war', 'hr', 'hi', 'et', 'az', 'gl', 'simple',
            'nn', 'new', 'th', 'el', 'roa-rup', 'la', 'ht', 'tl', 'ka', 'te',
            'mk', 'kk', 'sh', 'ceb', 'nap', 'pms', 'br', 'be-x-old', 'lv', 'jv',
            'mr', 'ta', 'sq', 'lb', 'cy', 'is', 'bs', 'be', 'oc', 'an', 'bpy',
            'bn', 'io', 'sw', 'lmo', 'fy', 'gu', 'mg', 'ml', 'af', 'nds', 'ur',
            'scn', 'qu', 'ku', 'zh-yue', 'pnb', 'ne', 'ast', 'yo', 'su', 'hy',
            'bat-smg', 'ga', 'cv', 'wa', 'kn', 'am', 'diq', 'als', 'tg', 'vec',
            'roa-tara', 'tt', 'zh-min-nan', 'yi', 'bug', 'gd', 'os', 'uz',
            'sah', 'pam', 'arz', 'mi', 'hsb', 'li', 'sco', 'nah', 'mn', 'my',
            'co', 'gan', 'glk', 'ia', 'hif', 'bcl', 'fo', 'sa', 'si', 'fiu-vro',
            'nds-nl', 'bar', 'vls', 'mrj', 'tk', 'ckb', 'gv', 'ilo', 'se',
            'map-bms', 'dv', 'nrm', 'pag', 'rm', 'mzn', 'bo', 'fur', 'wuu',
            'ug', 'mt', 'lij', 'csb', 'km', 'pi', 'ps', 'bh', 'ang', 'udm',
            'koi', 'lad', 'nov', 'sc', 'kv', 'zh-classical', 'mhr', 'cbk-zam',
            'ksh', 'frp', 'kw', 'rue', 'so', 'hak', 'nv', 'pa', 'szl', 'xal',
            'ie', 'rw', 'stq', 'haw', 'pdc', 'ln', 'ext', 'krc', 'to', 'pcd',
            'ky', 'crh', 'ace', 'myv', 'gn', 'ba', 'eml', 'ce', 'arc', 'kl',
            'or', 'pap', 'ay', 'frr', 'bjn', 'pfl', 'jbo', 'wo', 'tpi', 'kab',
            'ty', 'srn', 'gag', 'zea', 'dsb', 'lo', 'ab', 'ig', 'mdf', 'tet',
            'av', 'kg', 'mwl', 'rmy', 'ltg', 'cu', 'na', 'lbe', 'kaa', 'kbd',
            'as', 'sm', 'bm', 'ik', 'bi', 'sd', 'ss', 'ks', 'iu', 'pih', 'pnt',
            'got', 'cdo', 'chr', 'ee', 'ha', 'ti', 'za', 'bxr', 'om', 'zu',
            've', 'ts', 'rn', 'sg', 'dz', 'tum', 'cr', 'ch', 'lg', 'fj', 'ny',
            'st', 'xh', 'ff', 'tn', 'ki', 'sn', 'chy', 'ak', 'tw',
        ]
