...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ar', 'eo', 'sr', 'id', 'vi', 'lt', 'vo', 'sk', 'he', 'bg', 'fa',
            ...
            'sw', 'io', 'ksh', 'lmo', 'fy', 'gu', 'nds', 'af', 'qu', 'scn',
