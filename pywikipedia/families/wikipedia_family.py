...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh-yue', 'su', 'ast', 'hy', 'nap', 'yo', 'bat-smg', 'cv', 'ga',
            'wa', 'ne', 'pnb', 'kn', 'tg', 'roa-tara', 'vec', 'kk', 'tt', 'yi',
            'als', 'zh-min-nan', 'gd', 'os', 'uz', 'pam', 'sah', 'arz', 'am',
            'mi', 'li', 'hsb', 'nah', 'sco', 'bug', 'gan', 'co', 'glk', 'mn',
            'my', 'ia', 'bcl', 'fo', 'fiu-vro', 'nds-nl', 'si', 'vls', 'tk',
            ...
            'kv', 'rw', 'to', 'krc', 'mrj', 'crh', 'ln', 'pcd', 'ace', 'myv',
            'ext', 'ky', 'gn', 'ce', 'eml', 'ba', 'arc', 'pap', 'ay', 'bjn',
            'jbo', 'wo', 'kl', 'frr', 'tpi', 'kab', 'ty', 'srn', 'zea', 'gag',
            'ab', 'dsb', 'koi', 'lo', 'or', 'ig', 'av', 'kg', 'mdf', 'tet',
            'mwl', 'lbe', 'rmy', 'cu', 'ltg', 'kaa', 'sm', 'kbd', 'got', 'ks',
            'bm', 'ik', 'sd', 'bi', 'as', 'pfl', 'na', 'pih', 'iu', 'pnt', 'ss',
            'chr', 'cdo', 'ha', 'ee', 'ti', 'om', 'zu', 'za', 've', 'ts', 'bxr',
            'rn', 'sg', 'dz', 'cr', 'ch', 'lg', 'fj', 'tum', 'ny', 'st', 'ak',
            'xh', 'ff', 'tn', 'ki', 'sn', 'tw', 'chy',
        ]
