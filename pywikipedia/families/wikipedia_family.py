...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ka', 'te', 'mk', 'sh', 'pms', 'ceb', 'be-x-old', 'br', 'ta', 'jv',
            'lv', 'mr', 'cy', 'sq', 'lb', 'be', 'is', 'bs', 'oc', 'yo', 'an',
            'bpy', 'mg', 'bn', 'io', 'sw', 'fy', 'lmo', 'gu', 'ml', 'pnb', 'af',
            'nds', 'scn', 'ur', 'qu', 'ku', 'zh-yue', 'ne', 'ast', 'hy', 'su',
            'nap', 'ga', 'cv', 'bat-smg', 'tt', 'diq', 'wa', 'am', 'kn', 'als',
            'tg', 'zh-min-nan', 'bug', 'vec', 'roa-tara', 'yi', 'gd', 'arz',
            'os', 'sah', 'uz', 'pam', 'sco', 'my', 'hsb', 'mi', 'nah', 'li',
            'mn', 'ia', 'co', 'gan', 'glk', 'si', 'hif', 'sa', 'bcl', 'fo',
            'mrj', 'fiu-vro', 'bar', 'nds-nl', 'ckb', 'vls', 'tk', 'gv', 'ilo',
            'se', 'map-bms', 'dv', 'nrm', 'ba', 'pag', 'rm', 'mzn', 'bo', 'udm',
            'ps', 'fur', 'wuu', 'km', 'csb', 'ug', 'mt', 'lij', 'koi', 'pi',
            'ang', 'bh', 'kv', 'sc', 'lad', 'rue', 'nov', 'pa', 'zh-classical',
            'mhr', 'cbk-zam', 'ksh', 'so', 'kw', 'hak', 'frp', 'nv', 'szl',
            'ext', 'stq', 'ie', 'xal', 'rw', 'haw', 'ln', 'pdc', 'pcd', 'ky',
            'pfl', 'krc', 'to', 'crh', 'or', 'ace', 'myv', 'eml', 'gn', 'frr',
            'ay', 'arc', 'ce', 'kl', 'pap', 'bjn', 'lbe', 'jbo', 'wo', 'tpi',
            'mdf', 'kab', 'av', 'gag', 'ty', 'zea', 'srn', 'dsb', 'lo', 'xmf',
            'ab', 'ig', 'na', 'tet', 'kg', 'as', 'mwl', 'kaa', 'ltg', 'rmy',
