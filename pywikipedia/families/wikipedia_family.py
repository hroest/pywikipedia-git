...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'lv', 'mr', 'sq', 'cy', 'be', 'lb', 'is', 'bs', 'oc', 'yo', 'an',
            'mg', 'bpy', 'bn', 'io', 'fy', 'sw', 'lmo', 'gu', 'ml', 'pnb', 'af',
            'nds', 'scn', 'ur', 'ku', 'qu', 'zh-yue', 'ne', 'hy', 'diq', 'ast',
            'su', 'nap', 'ga', 'cv', 'bat-smg', 'tt', 'wa', 'am', 'kn', 'als',
            'tg', 'ia', 'zh-min-nan', 'bug', 'vec', 'roa-tara', 'yi', 'gd',
            ...
            'ps', 'udm', 'km', 'fur', 'wuu', 'csb', 'mt', 'ug', 'lij', 'koi',
            'pi', 'rue', 'ang', 'kv', 'bh', 'sc', 'lad', 'mhr', 'nov',
            'zh-classical', 'ksh', 'cbk-zam', 'hak', 'ky', 'so', 'kw', 'nv',
            'frp', 'szl', 'ext', 'stq', 'ie', 'xal', 'rw', 'haw', 'ln', 'pdc',
            'pcd', 'pfl', 'krc', 'to', 'or', 'crh', 'ace', 'eml', 'frr', 'myv',
            'gn', 'ay', 'arc', 'kl', 'ce', 'pap', 'bjn', 'lbe', 'gag', 'tpi',
            'jbo', 'wo', 'mdf', 'zea', 'av', 'kab', 'ty', 'srn', 'dsb', 'lo',
            'xmf', 'ab', 'as', 'ig', 'na', 'tet', 'kg', 'mwl', 'kaa', 'rmy',
            'ltg', 'cu', 'kbd', 'sm', 'sd', 'bi', 'bm', 'ik', 'iu', 'ss', 'pih',
            'sn', 'ks', 'pnt', 'za', 'chr', 'cdo', 'got', 'ee', 'ha', 'ti',
            'bxr', 'zu', 'om', 've', 'ts', 'rn', 'sg', 'cr', 'dz', 'tum', 'lg',
