...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'als', 'zh-min-nan', 'gd', 'os', 'uz', 'pam', 'sah', 'arz', 'bug',
            ...
            'rue', 'nv', 'pa', 'szl', 'xal', 'rw', 'haw', 'pdc', 'stq', 'ie',
            'so', 'udm', 'mhr', 'kv', 'to', 'ln', 'krc', 'crh', 'pcd', 'ace',
            'ky', 'ext', 'myv', 'gn', 'ce', 'eml', 'ba', 'arc', 'pap', 'ay',
            'bjn', 'jbo', 'kl', 'wo', 'frr', 'tpi', 'kab', 'ty', 'srn', 'zea',
            'gag', 'ab', 'dsb', 'koi', 'or', 'lo', 'ig', 'av', 'kg', 'tet',
            'mdf', 'mwl', 'lbe', 'rmy', 'cu', 'ltg', 'kaa', 'sm', 'kbd', 'got',
