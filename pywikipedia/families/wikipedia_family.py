...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'da', 'ar', 'eo', 'sr', 'id', 'lt', 'vo', 'sk', 'he', 'fa', 'bg',
            'sl', 'war', 'hr', 'ms', 'et', 'new', 'simple', 'gl', 'th', 'nn',
            'roa-rup', 'eu', 'hi', 'el', 'ht', 'la', 'tl', 'te', 'ka', 'ceb',
            'mk', 'az', 'br', 'sh', 'mr', 'lb', 'lv', 'jv', 'bs', 'is', 'cy',
            'be-x-old', 'pms', 'sq', 'ta', 'be', 'bpy', 'an', 'oc', 'bn', 'sw',
            'io', 'ksh', 'fy', 'lmo', 'gu', 'nds', 'af', 'qu', 'scn', 'ml',
            'ku', 'ur', 'su', 'zh-yue', 'ast', 'nap', 'bat-smg', 'wa', 'ga',
            'cv', 'hy', 'yo', 'ne', 'kn', 'pnb', 'tg', 'roa-tara', 'vec', 'gd',
            'yi', 'tt', 'zh-min-nan', 'uz', 'pam', 'os', 'sah', 'als', 'arz',
            'kk', 'mi', 'li', 'nah', 'hsb', 'glk', 'co', 'gan', 'am', 'mn',
            'ia', 'bcl', 'sco', 'fo', 'fiu-vro', 'nds-nl', 'si', 'tk', 'vls',
            'my', 'sa', 'mg', 'bar', 'gv', 'dv', 'ilo', 'nrm', 'rm', 'pag',
            'map-bms', 'diq', 'ckb', 'se', 'mzn', 'wuu', 'fur', 'ug', 'lij',
            'mt', 'bh', 'nov', 'ang', 'csb', 'sc', 'zh-classical', 'km', 'lad',
            'bo', 'cbk-zam', 'pi', 'hif', 'frp', 'hak', 'kw', 'ps', 'pa', 'szl',
            'xal', 'pdc', 'nv', 'haw', 'stq', 'ie', 'kv', 'fj', 'crh', 'so',
            'to', 'ace', 'myv', 'krc', 'mhr', 'gn', 'ext', 'ln', 'ky', 'pcd',
            'eml', 'arc', 'ay', 'jbo', 'wo', 'frr', 'ba', 'pap', 'bjn', 'kab',
            'tpi', 'ty', 'srn', 'zea', 'kl', 'ce', 'mrj', 'udm', 'koi', 'ig',
            'dsb', 'or', 'kg', 'lo', 'ab', 'mdf', 'rmy', 'mwl', 'cu', 'kaa',
            'sm', 'tet', 'av', 'ks', 'got', 'sd', 'bm', 'bi', 'na', 'pih', 'ik',
            'iu', 'pnt', 'chr', 'as', 'cdo', 'ss', 'ee', 'zu', 'om', 'za', 'ti',
            've', 'ts', 'ha', 'dz', 'sg', 'ch', 'cr', 'bxr', 'ak', 'xh', 'rw',
            'st', 'bug', 'tn', 'ki', 'ny', 'lbe', 'tw', 'sn', 'rn', 'ff', 'chy',
            'tum', 'lg', 'gag', 'pfl',
        ]
        ...
        self.alphabetic_latin = [
            ...
            'kv', 'kg', 'ht', 'ks', 'ku', 'kj', 'lad', 'lbe', 'la', 'lv', 'to',
            'lb', 'lt', 'lij', 'li', 'ln', 'lo', 'jbo', 'lg', 'lmo', 'hu', 'mk',
            'mg', 'mt', 'mi', 'cdo', 'mwl', 'ml', 'mdf', 'mo', 'mn', 'mr',
            'mus', 'my', 'mzn', 'nah', 'fj', 'ne', 'nl', 'nds-nl', 'cr', 'new',
            'nap', 'ce', 'frr', 'pih', 'no', 'nb', 'nn', 'nrm', 'nov', 'oc',
            'mhr', 'or', 'om', 'ng', 'hz', 'uz', 'pa', 'pfl', 'pag', 'pap',
            'koi', 'pi', 'pcd', 'pms', 'nds', 'pnb', 'pl', 'pt', 'pnt', 'ps',
            'aa', 'kaa', 'crh', 'ty', 'ksh', 'ro', 'rmy', 'rm', 'qu', 'ru',
            'sa', 'sah', 'se', 'sg', 'sc', 'sco', 'sd', 'stq', 'st', 'tn', 'sq',
            'si', 'scn', 'simple', 'ss', 'sk', 'sl', 'cu', 'szl', 'so', 'ckb',
            'srn', 'sr', 'sh', 'fi', 'sv', 'ta', 'tl', 'kab', 'roa-tara', 'tt',
            'te', 'tet', 'th', 'ti', 'vi', 'tg', 'tokipona', 'tp', 'tpi', 'chy',
            've', 'tr', 'tk', 'tw', 'udm', 'uk', 'ur', 'ug', 'za', 'vec', 'vo',
            'fiu-vro', 'wa', 'vls', 'war', 'wo', 'wuu', 'ts', 'yi', 'yo', 'diq',
            'zea', 'zh', 'zh-tw', 'zh-cn', 'zh-classical', 'zh-yue', 'bat-smg',
        ]
