...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sl', 'hr', 'et', 'war', 'new', 'ms', 'simple', 'th', 'gl', 'nn',
            'eu', 'hi', 'el', 'ht', 'te', 'ka', 'roa-rup', 'ceb', 'mk', 'la',
            'az', 'br', 'sh', 'mr', 'lb', 'jv', 'bs', 'is', 'lv', 'tl', 'cy',
            'pms', 'sq', 'be-x-old', 'bpy', 'ta', 'oc', 'bn', 'an', 'be', 'io',
            'sw', 'fy', 'nds', 'scn', 'af', 'gu', 'qu', 'lmo', 'su', 'zh-yue',
            'ast', 'ur', 'nap', 'ku', 'ml', 'bat-smg', 'wa', 'cv', 'ksh', 'ga',
            'hy', 'tg', 'yo', 'roa-tara', 'vec', 'kn', 'gd', 'yi', 'uz', 'pam',
            'os', 'zh-min-nan', 'sah', 'mi', 'tt', 'als', 'kk', 'arz', 'nah',
            'li', 'hsb', 'glk', 'co', 'gan', 'ia', 'ne', 'bcl', 'pnb', 'mn',
            'fiu-vro', 'nds-nl', 'vls', 'am', 'fo', 'tk', 'sa', 'si', 'dv',
            'bar', 'nrm', 'pag', 'gv', 'rm', 'map-bms', 'my', 'sco', 'diq',
            'se', 'wuu', 'fur', 'lij', 'ug', 'bh', 'mt', 'nov', 'mzn', 'csb',
            'mg', 'ilo', 'zh-classical', 'km', 'pi', 'lad', 'sc', 'ang', 'frp',
            'bo', 'hif', 'kw', 'ckb', 'xal', 'hak', 'pdc', 'haw', 'szl', 'ps',
            'pa', 'ie', 'fj', 'kv', 'crh', 'to', 'stq', 'myv', 'ace', 'gn',
            'ln', 'krc', 'cbk-zam', 'nv', 'ky', 'mhr', 'ext', 'so', 'arc', 'ty',
            'jbo', 'wo', 'eml', 'kab', 'tpi', 'pap', 'zea', 'srn', 'ay', 'ba',
            'or', 'ig', 'dsb', 'kl', 'udm', 'ce', 'kg', 'lo', 'rmy', 'pcd',
            'cu', 'ab', 'mwl', 'kaa', 'sm', 'av', 'ks', 'mdf', 'tet', 'got',
            'sd', 'na', 'bm', 'pih', 'pnt', 'iu', 'cdo', 'as', 'bug', 'ee',
            'chr', 'bi', 'om', 'za', 'ti', 'ss', 'ts', 've', 'ha', 'zu', 'sg',
