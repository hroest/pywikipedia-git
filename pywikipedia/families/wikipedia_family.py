...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'wa', 'ne', 'pnb', 'ksh', 'kn', 'tg', 'roa-tara', 'vec', 'yi', 'gd',
            'zh-min-nan', 'als', 'tt', 'os', 'uz', 'pam', 'sah', 'kk', 'arz',
            'am', 'mi', 'li', 'nah', 'hsb', 'sco', 'gan', 'glk', 'co', 'mn',
            'ia', 'my', 'bcl', 'fo', 'bug', 'fiu-vro', 'nds-nl', 'si', 'tk',
            'vls', 'sa', 'bar', 'mg', 'gv', 'ilo', 'dv', 'nrm', 'pag',
            'map-bms', 'ckb', 'rm', 'diq', 'se', 'mzn', 'wuu', 'fur', 'ug',
            'lij', 'mt', 'bh', 'bo', 'nov', 'ang', 'csb', 'hif', 'sc',
            'zh-classical', 'km', 'lad', 'cbk-zam', 'pi', 'frp', 'ps', 'hak',
            'kw', 'pa', 'nv', 'rue', 'szl', 'xal', 'pdc', 'haw', 'stq', 'ie',
            'so', 'udm', 'kv', 'krc', 'rw', 'to', 'crh', 'mhr', 'ace', 'pcd',
            'myv', 'ln', 'ext', 'ky', 'gn', 'eml', 'arc', 'pap', 'ba', 'ay',
            'ce', 'jbo', 'wo', 'bjn', 'frr', 'kl', 'mrj', 'tpi', 'kab', 'ty',
            'srn', 'zea', 'gag', 'ab', 'koi', 'dsb', 'ig', 'or', 'lo', 'kg',
            'mdf', 'av', 'mwl', 'rmy', 'cu', 'kaa', 'sm', 'tet', 'got', 'ks',
            'bm', 'lbe', 'ik', 'sd', 'bi', 'na', 'pfl', 'pih', 'iu', 'pnt',
            'as', 'ss', 'chr', 'cdo', 'ha', 'ee', 'ti', 'om', 'zu', 'za', 've',
            'ts', 'sg', 'rn', 'dz', 'cr', 'ch', 'lg', 'tum', 'bxr', 'ny', 'fj',
