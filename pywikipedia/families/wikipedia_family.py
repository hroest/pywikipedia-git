...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'uk', 'ca', 'vi', 'no', 'fi', 'cs', 'hu', 'ko', 'id', 'tr',
            'ro', 'fa', 'ar', 'da', 'eo', 'sr', 'lt', 'sk', 'sl', 'ms', 'he',
            'bg', 'kk', 'eu', 'vo', 'war', 'hr', 'hi', 'et', 'az', 'gl', 'nn',
            'simple', 'th', 'la', 'el', 'new', 'roa-rup', 'oc', 'tl', 'ka',
            ...
            'bcl', 'fo', 'ckb', 'bar', 'ky', 'bo', 'mrj', 'ilo', 'fiu-vro',
            'nds-nl', 'tk', 'vls', 'se', 'gv', 'dv', 'nrm', 'rue', 'pag', 'pa',
            'ps', 'rm', 'mzn', 'km', 'udm', 'csb', 'fur', 'mt', 'wuu', 'kv',
            'ug', 'koi', 'lij', 'mhr', 'ang', 'pi', 'lad', 'bh', 'sc', 'zea',
            'zh-classical', 'nov', 'ksh', 'cbk-zam', 'so', 'or', 'nv', 'hak',
            'kw', 'frp', 'stq', 'xmf', 'szl', 'ext', 'pcd', 'ie', 'frr', 'xal',
            'haw', 'rw', 'ln', 'ay', 'pdc', 'pfl', 'krc', 'ace', 'to', 'crh',
            'eml', 'ce', 'gn', 'myv', 'kl', 'arc', 'gag', 'pap', 'bjn', 'lbe',
            'tpi', 'as', 'wo', 'dsb', 'jbo', 'mdf', 'av', 'kab', 'sn', 'ty',
            'srn', 'lo', 'ab', 'ig', 'na', 'mwl', 'kg', 'tet', 'ltg', 'kaa',
            'nso', 'rmy', 'cu', 'tn', 'kbd', 'sm', 'bi', 'sd', 'bm', 'ik', 'iu',
            'ss', 'pih', 'za', 'chr', 'pnt', 'got', 'cdo', 'ee', 'ha', 'zu',
            'ti', 'ks', 'om', 'bxr', 've', 'ts', 'sg', 'rn', 'cr', 'dz', 'lg',
            'ak', 'chy', 'fj', 'tum', 'st', 'ch', 'xh', 'ny', 'tw', 'ff', 'ki',
            'vep',
        ]
