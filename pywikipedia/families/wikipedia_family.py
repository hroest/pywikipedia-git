...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ka', 'mk', 'te', 'sh', 'pms', 'ceb', 'be-x-old', 'br', 'ta', 'jv',
            'lv', 'mr', 'sq', 'cy', 'lb', 'be', 'is', 'bs', 'oc', 'yo', 'an',
            'bpy', 'mg', 'bn', 'io', 'fy', 'sw', 'lmo', 'gu', 'ml', 'pnb', 'af',
            'nds', 'scn', 'ur', 'qu', 'ku', 'zh-yue', 'ne', 'diq', 'hy', 'ast',
            'su', 'nap', 'ga', 'cv', 'bat-smg', 'tt', 'wa', 'am', 'kn', 'als',
            'tg', 'zh-min-nan', 'bug', 'ia', 'vec', 'roa-tara', 'yi', 'gd',
            'arz', 'os', 'sah', 'uz', 'pam', 'my', 'sco', 'nah', 'hsb', 'mi',
            'li', 'mn', 'co', 'sa', 'gan', 'glk', 'ba', 'si', 'hif', 'bcl',
            'fo', 'mrj', 'ckb', 'bar', 'fiu-vro', 'nds-nl', 'vls', 'tk', 'gv',
            'ilo', 'se', 'map-bms', 'dv', 'nrm', 'pag', 'pa', 'rm', 'mzn', 'bo',
            'udm', 'ps', 'km', 'fur', 'wuu', 'csb', 'mt', 'ug', 'lij', 'koi',
            'pi', 'rue', 'ang', 'kv', 'bh', 'sc', 'lad', 'nov', 'mhr',
            'zh-classical', 'ksh', 'cbk-zam', 'hak', 'so', 'kw', 'nv', 'frp',
            'szl', 'ky', 'ext', 'stq', 'ie', 'xal', 'rw', 'haw', 'ln', 'pdc',
            'pcd', 'pfl', 'krc', 'to', 'or', 'crh', 'ace', 'eml', 'myv', 'frr',
            'gn', 'ay', 'arc', 'kl', 'ce', 'pap', 'bjn', 'lbe', 'tpi', 'gag',
            'jbo', 'wo', 'mdf', 'av', 'zea', 'kab', 'ty', 'srn', 'dsb', 'xmf',
            'lo', 'ab', 'ig', 'as', 'na', 'tet', 'kg', 'mwl', 'ltg', 'kaa',
            'rmy', 'cu', 'kbd', 'sm', 'sd', 'bm', 'bi', 'ik', 'ss', 'iu', 'pih',
            'ks', 'pnt', 'za', 'chr', 'cdo', 'sn', 'got', 'ee', 'ha', 'ti',
            'bxr', 'om', 'zu', 've', 'ts', 'rn', 'sg', 'cr', 'dz', 'tum', 'lg',
            'fj', 'ch', 'ny', 'ff', 'tn', 'st', 'xh', 'ak', 'chy', 'ki', 'tw',
        ]
    ...
    def version(self, code):
        return '1.18wmf1' if code in ('eo', 'nl', 'simple') else '1.17wmf1'
