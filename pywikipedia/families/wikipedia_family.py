...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            'en', 'de', 'fr', 'nl', 'it', 'es', 'pl', 'ru', 'ja', 'pt', 'sv',
            'zh', 'ca', 'uk', 'no', 'fi', 'vi', 'cs', 'hu', 'ko', 'id', 'tr',
            'ro', 'fa', 'ar', 'da', 'eo', 'sr', 'lt', 'sk', 'ms', 'he', 'bg',
            'sl', 'vo', 'kk', 'war', 'eu', 'hr', 'hi', 'et', 'az', 'gl',
            'simple', 'nn', 'th', 'new', 'el', 'la', 'roa-rup', 'oc', 'tl',
            'ht', 'ka', 'mk', 'sh', 'te', 'pms', 'ceb', 'ta', 'be-x-old', 'br',
            'lv', 'jv', 'sq', 'be', 'mr', 'cy', 'lb', 'is', 'bs', 'yo', 'mg',
            'an', 'bpy', 'lmo', 'fy', 'bn', 'io', 'sw', 'gu', 'ml', 'pnb', 'af',
            'nds', 'scn', 'ur', 'ku', 'zh-yue', 'hy', 'qu', 'ne', 'su', 'diq',
            'ast', 'tt', 'ga', 'nap', 'cv', 'bat-smg', 'wa', 'am', 'kn', 'ia',
            'als', 'bug', 'my', 'zh-min-nan', 'tg', 'vec', 'yi', 'roa-tara',
            'gd', 'os', 'arz', 'nah', 'sah', 'uz', 'sco', 'pam', 'mn', 'hsb',
            'mi', 'sa', 'li', 'co', 'ba', 'gan', 'glk', 'si', 'hif', 'bcl',
            'fo', 'mrj', 'bo', 'bar', 'ckb', 'fiu-vro', 'nds-nl', 'tk', 'vls',
            'ilo', 'gv', 'se', 'map-bms', 'ky', 'dv', 'nrm', 'pag', 'pa', 'rue',
            'mzn', 'rm', 'km', 'ps', 'udm', 'fur', 'csb', 'wuu', 'mt', 'ug',
            'lij', 'koi', 'pi', 'kv', 'ang', 'mhr', 'bh', 'lad', 'sc', 'nov',
            'zh-classical', 'ksh', 'cbk-zam', 'hak', 'so', 'nv', 'kw', 'frp',
            'stq', 'szl', 'ext', 'ie', 'xal', 'or', 'haw', 'rw', 'ln', 'pcd',
            'pdc', 'frr', 'pfl', 'krc', 'to', 'ace', 'crh', 'eml', 'gn', 'myv',
            'arc', 'ay', 'kl', 'ce', 'xmf', 'pap', 'gag', 'bjn', 'lbe', 'tpi',
            'wo', 'jbo', 'zea', 'mdf', 'av', 'kab', 'dsb', 'ty', 'srn', 'sn',
            'as', 'lo', 'ab', 'ig', 'na', 'tet', 'kg', 'mwl', 'kaa', 'ltg',
            'rmy', 'cu', 'kbd', 'sm', 'sd', 'bi', 'bm', 'ik', 'ss', 'iu', 'pih',
            'za', 'pnt', 'chr', 'tn', 'cdo', 'got', 'ee', 'ha', 'zu', 'ti',
            'ks', 'bxr', 'om', 've', 'ts', 'sg', 'rn', 'dz', 'cr', 'ak', 'tum',
            'lg', 'fj', 'ch', 'ny', 'chy', 'st', 'ff', 'tw', 'xh', 'ki',
        ]
        ...
        self.namespaces[4] = {
            ...
            'arz': u'ويكيبيديا',
            'as': [u'Wikipedia', u'ৱিকিপিডিয়া', u'প্ৰকল্প'],
            'ast': u'Uiquipedia',
            'av': u'Wikipedia',
            'ay': u'Wikipidiya',
            'az': u'Vikipediya',
        ...
        self.namespaces[5] = {
            ...
            'as': [u'Wikipedia বাৰ্তা', u'ৱিকিপিডিয়া আলোচনা', u'প্ৰকল্প আলোচনা', u'Wikipedia वार्ता', u'Wikipedia বার্তা'],
        ...
        self.cross_allowed = [
            ...
            'ia', 'ie', 'ig', 'ik', 'ilo', 'iu', 'ja', 'jbo', 'jv', 'kaa',
            'kab', 'ka', 'kg', 'ki', 'kk', 'kl', 'km', 'kn', 'ko', 'koi', 'ks',
            'ku', 'kv', 'kw', 'ky', 'lad', 'lb', 'lbe', 'lg', 'li', 'lij',
            'lmo', 'ln', 'lo', 'lv', 'map-bms', 'mdf', 'mg', 'mhr', 'mi', 'mk',
            'mn', 'mrj', 'ms', 'mwl', 'myv', 'my', 'mzn', 'nah', 'na', 'nap',
            'nds-nl', 'ne', 'new', 'nl', 'nov', 'nrm', 'nv', 'ny', 'oc', 'om',
            'or', 'os', 'pam', 'pap', 'pa', 'pag', 'pdc', 'pfl', 'pi', 'pih',
        ...
        self.alphabetic_latin = [
            ...
            'to', 'lb', 'lt', 'lij', 'li', 'ln', 'lo', 'jbo', 'lg', 'lmo', 'hu',
            'mk', 'mg', 'mt', 'mi', 'cdo', 'mwl', 'ml', 'mdf', 'mo', 'mn', 'mr',
            ...
            'nso', 'tn', 'sq', 'si', 'scn', 'simple', 'ss', 'sk', 'sl', 'cu',
