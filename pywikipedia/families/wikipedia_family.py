...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'hif', 'ckb', 'kw', 'hak', 'pa', 'xal', 'pdc', 'szl', 'haw', 'ps',
            'ie', 'cbk-zam', 'fj', 'kv', 'crh', 'to', 'stq', 'ace', 'myv', 'so',
            'gn', 'krc', 'nv', 'ln', 'ky', 'mhr', 'ext', 'arc', 'jbo', 'wo',
            'eml', 'kab', 'pcd', 'ty', 'tpi', 'pap', 'zea', 'ay', 'srn', 'ba',
            'ce', 'kl', 'or', 'ig', 'dsb', 'udm', 'kg', 'lo', 'rmy', 'ab', 'cu',
            'mwl', 'kaa', 'mdf', 'sm', 'av', 'ks', 'tet', 'got', 'sd', 'na',
            'bm', 'pih', 'pnt', 'iu', 'cdo', 'as', 'bi', 'ee', 'bug', 'chr',
            'om', 'ik', 'za', 'ti', 'ss', 'ts', 've', 'ha', 'zu', 'sg', 'dz',
            'ch', 'cr', 'xh', 'ak', 'rw', 'lbe', 'ki', 'tn', 'bxr', 'st', 'tw',
            'ny', 'rn', 'sn', 'chy', 'ff', 'lg', 'tum',
        ]
