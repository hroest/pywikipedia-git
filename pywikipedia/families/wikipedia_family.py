...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sl', 'war', 'ms', 'hr', 'et', 'new', 'simple', 'gl', 'th', 'eu',
            'nn', 'roa-rup', 'el', 'hi', 'ht', 'az', 'la', 'te', 'tl', 'ka',
            'mk', 'ceb', 'sh', 'br', 'mr', 'pms', 'lv', 'lb', 'jv', 'be-x-old',
            'cy', 'is', 'bs', 'sq', 'ta', 'be', 'bpy', 'an', 'oc', 'bn', 'sw',
            'io', 'fy', 'lmo', 'gu', 'nds', 'af', 'qu', 'scn', 'ml', 'ku', 'ur',
            'su', 'zh-yue', 'ast', 'nap', 'bat-smg', 'hy', 'ga', 'cv', 'wa',
            'ksh', 'yo', 'ne', 'pnb', 'kn', 'tg', 'roa-tara', 'vec', 'yi', 'gd',
            'tt', 'zh-min-nan', 'uz', 'os', 'pam', 'sah', 'als', 'arz', 'kk',
            'mi', 'li', 'nah', 'am', 'hsb', 'glk', 'co', 'gan', 'mn', 'ia',
            'sco', 'bcl', 'fo', 'my', 'fiu-vro', 'si', 'nds-nl', 'tk', 'vls',
            'sa', 'bar', 'mg', 'gv', 'ilo', 'dv', 'nrm', 'pag', 'map-bms', 'rm',
            'ckb', 'diq', 'se', 'mzn', 'fur', 'wuu', 'ug', 'lij', 'mt', 'bh',
            'nov', 'ang', 'csb', 'bo', 'sc', 'zh-classical', 'hif', 'km', 'lad',
            'cbk-zam', 'pi', 'frp', 'ps', 'hak', 'kw', 'pa', 'nv', 'szl', 'xal',
            'pdc', 'haw', 'stq', 'ie', 'kv', 'fj', 'so', 'crh', 'to', 'ace',
            'myv', 'krc', 'mhr', 'pcd', 'ln', 'ext', 'gn', 'ky', 'eml', 'arc',
            'ay', 'jbo', 'wo', 'frr', 'bjn', 'pap', 'kl', 'ba', 'tpi', 'kab',
            'ty', 'ce', 'udm', 'srn', 'zea', 'mrj', 'koi', 'dsb', 'ig', 'ab',
            'or', 'kg', 'lo', 'gag', 'av', 'mdf', 'mwl', 'rmy', 'cu', 'rw',
            'kaa', 'sm', 'tet', 'ks', 'got', 'bm', 'ik', 'sd', 'bi', 'lbe',
            'na', 'pih', 'iu', 'pnt', 'chr', 'as', 'ss', 'cdo', 'pfl', 'ha',
            'ee', 'ti', 'zu', 'om', 'za', 've', 'ts', 'dz', 'sg', 'rn', 'cr',
            'ch', 'lg', 'bug', 'bxr', 'xh', 'ak', 'ny', 'st', 'tn', 'ff', 'ki',
            'sn', 'tum', 'tw', 'chy',
        ]
