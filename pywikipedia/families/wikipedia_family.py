...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'eu', 'hi', 'el', 'ht', 'te', 'ka', 'ceb', 'roa-rup', 'mk', 'la',
            'az', 'br', 'sh', 'lb', 'bs', 'jv', 'mr', 'is', 'lv', 'tl', 'cy',
            'pms', 'sq', 'be-x-old', 'bpy', 'ta', 'oc', 'bn', 'an', 'be', 'io',
            'sw', 'fy', 'nds', 'scn', 'af', 'qu', 'gu', 'lmo', 'su', 'zh-yue',
            'ast', 'ur', 'nap', 'ku', 'ml', 'bat-smg', 'wa', 'cv', 'ksh', 'ga',
            'hy', 'tg', 'yo', 'roa-tara', 'vec', 'kn', 'gd', 'yi', 'uz', 'pam',
            'os', 'zh-min-nan', 'sah', 'mi', 'tt', 'als', 'kk', 'nah', 'li',
            ...
            'hif', 'bo', 'kw', 'ckb', 'hak', 'pdc', 'haw', 'szl', 'ps', 'pa',
            'xal', 'ie', 'fj', 'kv', 'crh', 'to', 'stq', 'myv', 'ace', 'gn',
            'ln', 'cbk-zam', 'krc', 'nv', 'ky', 'mhr', 'ext', 'arc', 'jbo',
            'wo', 'ty', 'so', 'eml', 'kab', 'tpi', 'pap', 'zea', 'srn', 'ay',
            'ba', 'or', 'ig', 'dsb', 'kl', 'ce', 'kg', 'udm', 'lo', 'rmy', 'cu',
            'ab', 'mwl', 'pcd', 'kaa', 'sm', 'av', 'ks', 'tet', 'got', 'mdf',
