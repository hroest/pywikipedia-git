...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'pdc', 'haw', 'stq', 'ie', 'so', 'kv', 'crh', 'to', 'ace', 'mhr',
            'myv', 'pcd', 'krc', 'ln', 'ext', 'gn', 'ky', 'eml', 'arc', 'pap',
            'ay', 'rw', 'jbo', 'wo', 'bjn', 'frr', 'ce', 'ba', 'kl', 'tpi',
            'kab', 'udm', 'ty', 'srn', 'zea', 'mrj', 'koi', 'dsb', 'ig', 'ab',
            'or', 'gag', 'kg', 'lo', 'av', 'mdf', 'mwl', 'rmy', 'cu', 'kaa',
            'sm', 'tet', 'got', 'ks', 'bm', 'ik', 'sd', 'bi', 'lbe', 'na',
            'pih', 'iu', 'pnt', 'chr', 'cdo', 'as', 'ss', 'pfl', 'ha', 'ee',
            'ti', 'om', 'zu', 'za', 've', 'ts', 'rn', 'dz', 'sg', 'cr', 'ch',
            'lg', 'bug', 'bxr', 'fj', 'ak', 'st', 'xh', 'ny', 'tn', 'ff', 'ki',
            'tum', 'sn', 'tw', 'chy',
        ]
