...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            'en', 'de', 'fr', 'pl', 'it', 'ja', 'es', 'ru', 'pt', 'nl', 'sv',
            'zh', 'ca', 'no', 'uk', 'fi', 'vi', 'cs', 'hu', 'ko', 'ro', 'id',
            'tr', 'da', 'ar', 'eo', 'sr', 'lt', 'sk', 'fa', 'vo', 'he', 'ms',
            'bg', 'sl', 'war', 'hr', 'et', 'hi', 'gl', 'new', 'simple', 'th',
            'eu', 'nn', 'roa-rup', 'el', 'az', 'ht', 'la', 'tl', 'te', 'ka',
            'mk', 'ceb', 'sh', 'br', 'pms', 'be-x-old', 'lv', 'mr', 'jv', 'lb',
            'cy', 'sq', 'bs', 'is', 'ta', 'be', 'an', 'bpy', 'oc', 'bn', 'io',
            'sw', 'lmo', 'fy', 'gu', 'ml', 'nds', 'af', 'scn', 'ur', 'qu', 'ku',
            'zh-yue', 'su', 'ast', 'hy', 'nap', 'bat-smg', 'yo', 'ga', 'cv',
            'wa', 'ne', 'pnb', 'kn', 'tg', 'roa-tara', 'vec', 'kk', 'tt', 'yi',
            'als', 'zh-min-nan', 'gd', 'os', 'uz', 'pam', 'sah', 'arz', 'am',
            'mi', 'li', 'nah', 'hsb', 'sco', 'gan', 'co', 'glk', 'mn', 'bug',
            'ia', 'my', 'bcl', 'fo', 'fiu-vro', 'nds-nl', 'si', 'vls', 'tk',
            'sa', 'bar', 'mg', 'gv', 'ilo', 'dv', 'map-bms', 'nrm', 'pag',
            'ckb', 'diq', 'rm', 'se', 'mzn', 'wuu', 'fur', 'ug', 'lij', 'mt',
            'bo', 'bh', 'ang', 'nov', 'hif', 'csb', 'sc', 'lad', 'zh-classical',
            'km', 'cbk-zam', 'pi', 'ps', 'frp', 'hak', 'kw', 'rue', 'ksh', 'pa',
            'nv', 'szl', 'xal', 'pdc', 'haw', 'stq', 'ie', 'udm', 'so', 'mhr',
            'kv', 'rw', 'to', 'krc', 'crh', 'ln', 'mrj', 'pcd', 'ace', 'myv',
            'ext', 'ky', 'gn', 'ce', 'eml', 'ba', 'arc', 'pap', 'ay', 'bjn',
            'jbo', 'wo', 'kl', 'frr', 'tpi', 'kab', 'ty', 'srn', 'zea', 'gag',
            'ab', 'dsb', 'koi', 'lo', 'or', 'ig', 'av', 'kg', 'mdf', 'tet',
            'mwl', 'lbe', 'rmy', 'cu', 'kaa', 'sm', 'got', 'ks', 'bm', 'ik',
            'sd', 'bi', 'as', 'pfl', 'na', 'pih', 'iu', 'pnt', 'ss', 'chr',
            'cdo', 'ha', 'ee', 'ti', 'om', 'zu', 'za', 've', 'ts', 'bxr', 'rn',
            'sg', 'dz', 'cr', 'ch', 'lg', 'fj', 'tum', 'ny', 'st', 'ak', 'xh',
            'ff', 'tn', 'ki', 'sn', 'tw', 'chy',
        ]
        ...
        self.alphabetic_latin = [
            ...
            'rue', 'sa', 'sah', 'se', 'sg', 'sc', 'sco', 'sd', 'stq', 'st',
