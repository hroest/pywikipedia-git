...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'eu', 'roa-rup', 'hi', 'el', 'ht', 'la', 'az', 'te', 'tl', 'ka',
            'mk', 'ceb', 'sh', 'br', 'mr', 'lb', 'lv', 'pms', 'jv', 'be-x-old',
            ...
            'ty', 'srn', 'zea', 'udm', 'ce', 'mrj', 'koi', 'ig', 'ab', 'dsb',
            'or', 'kg', 'lo', 'gag', 'av', 'mdf', 'rmy', 'mwl', 'cu', 'kaa',
            'sm', 'tet', 'ks', 'got', 'bm', 'ik', 'sd', 'bi', 'na', 'lbe',
            'pih', 'iu', 'pnt', 'chr', 'as', 'ss', 'cdo', 'pfl', 'ha', 'ee',
            'ti', 'om', 'zu', 'za', 've', 'ts', 'dz', 'sg', 'cr', 'ch', 'rw',
            'lg', 'bug', 'rn', 'bxr', 'ak', 'xh', 'ny', 'st', 'tn', 'ff', 'ki',
            'sn', 'tum', 'tw', 'chy',
        ]
