...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ceb', 'az', 'br', 'sh', 'tl', 'mr', 'jv', 'lb', 'bs', 'is', 'lv',
            'cy', 'pms', 'sq', 'be-x-old', 'bpy', 'ta', 'oc', 'an', 'bn', 'be',
            'io', 'sw', 'fy', 'nds', 'lmo', 'scn', 'gu', 'af', 'qu', 'su',
            'zh-yue', 'ur', 'ast', 'ml', 'ku', 'nap', 'bat-smg', 'wa', 'cv',
            'ga', 'ksh', 'hy', 'yo', 'tg', 'kn', 'roa-tara', 'vec', 'gd', 'yi',
            'uz', 'pam', 'zh-min-nan', 'os', 'tt', 'sah', 'als', 'mi', 'ne',
            'arz', 'kk', 'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'pnb', 'ia',
            'bcl', 'mn', 'fiu-vro', 'am', 'nds-nl', 'fo', 'vls', 'tk', 'sa',
            'si', 'bar', 'dv', 'nrm', 'gv', 'pag', 'rm', 'map-bms', 'my', 'sco',
            'diq', 'se', 'wuu', 'fur', 'fj', 'lij', 'ug', 'bh', 'mt', 'nov',
            'mzn', 'csb', 'mg', 'ilo', 'km', 'zh-classical', 'sc', 'lad', 'pi',
            'ang', 'cbk-zam', 'frp', 'bo', 'hak', 'ckb', 'hif', 'pa', 'kw',
            'xal', 'szl', 'pdc', 'haw', 'ps', 'ie', 'stq', 'crh', 'kv', 'to',
            'ace', 'myv', 'so', 'nv', 'gn', 'ky', 'krc', 'ln', 'ext', 'mhr',
            'arc', 'jbo', 'wo', 'eml', 'pcd', 'ty', 'kab', 'tpi', 'pap', 'ay',
            'zea', 'ba', 'srn', 'kl', 'udm', 'ig', 'ce', 'or', 'dsb', 'kg',
            'lo', 'ee', 'ab', 'rmy', 'cu', 'mwl', 'mdf', 'kaa', 'sm', 'av',
            'ks', 'tet', 'got', 'sd', 'na', 'bm', 'pih', 'pnt', 'iu', 'ik',
            'as', 'cdo', 'bi', 'chr', 'bug', 'om', 'za', 'ss', 'ti', 'ts', 've',
            'ha', 'zu', 'sg', 'dz', 'ch', 'cr', 'xh', 'lbe', 'ak', 'rw', 'ki',
