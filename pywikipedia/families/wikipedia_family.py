...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'mk', 'ceb', 'sh', 'br', 'pms', 'lv', 'mr', 'lb', 'be-x-old', 'jv',
            'sq', 'cy', 'is', 'bs', 'ta', 'be', 'bpy', 'an', 'oc', 'bn', 'io',
            'sw', 'lmo', 'fy', 'gu', 'af', 'nds', 'ml', 'qu', 'ur', 'scn', 'ku',
            ...
            'lij', 'mt', 'bh', 'bo', 'nov', 'ang', 'csb', 'sc', 'zh-classical',
            'hif', 'km', 'lad', 'cbk-zam', 'pi', 'frp', 'ps', 'hak', 'kw', 'pa',
            'nv', 'szl', 'xal', 'pdc', 'haw', 'stq', 'ie', 'so', 'kv', 'krc',
            'crh', 'to', 'ace', 'rw', 'mhr', 'rue', 'pcd', 'myv', 'ln', 'ext',
            'gn', 'ky', 'udm', 'eml', 'arc', 'bjn', 'pap', 'ay', 'ce', 'ba',
            'jbo', 'wo', 'frr', 'kl', 'tpi', 'kab', 'ty', 'mrj', 'srn', 'zea',
            'gag', 'koi', 'dsb', 'ab', 'ig', 'or', 'lo', 'kg', 'mdf', 'av',
            'mwl', 'rmy', 'cu', 'kaa', 'sm', 'tet', 'got', 'ks', 'bm', 'ik',
            'sd', 'bi', 'lbe', 'na', 'pih', 'iu', 'pfl', 'pnt', 'as', 'chr',
            'cdo', 'ss', 'ha', 'ee', 'ti', 'om', 'zu', 'za', 've', 'ts', 'rn',
            'sg', 'cr', 'dz', 'ch', 'lg', 'tum', 'bxr', 'fj', 'ny', 'ak', 'st',
