...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sw', 'io', 'fy', 'nds', 'gu', 'lmo', 'scn', 'af', 'qu', 'ku', 'su',
            'zh-yue', 'ur', 'ml', 'ast', 'nap', 'bat-smg', 'wa', 'ga', 'cv',
            'ksh', 'hy', 'yo', 'tg', 'kn', 'roa-tara', 'vec', 'gd', 'yi',
            'zh-min-nan', 'uz', 'pam', 'os', 'tt', 'sah', 'ne', 'als', 'mi',
            'kk', 'arz', 'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'pnb', 'ia',
            'bcl', 'mn', 'am', 'fiu-vro', 'nds-nl', 'fo', 'vls', 'tk', 'sa',
            ...
            'pdc', 'szl', 'haw', 'ps', 'ie', 'stq', 'fj', 'crh', 'kv', 'to',
            'ace', 'myv', 'so', 'nv', 'gn', 'ee', 'ky', 'krc', 'ln', 'ext',
            'mhr', 'arc', 'jbo', 'wo', 'eml', 'pcd', 'kab', 'ty', 'tpi', 'ay',
            'pap', 'ba', 'zea', 'srn', 'kl', 'udm', 'ig', 'ce', 'or', 'dsb',
            'kg', 'lo', 'ab', 'rmy', 'cu', 'mwl', 'frr', 'mdf', 'kaa', 'sm',
