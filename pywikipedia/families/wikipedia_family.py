...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ka', 'mk', 'oc', 'sh', 'te', 'pms', 'ceb', 'be-x-old', 'ta', 'br',
            'lv', 'jv', 'be', 'mr', 'sq', 'cy', 'lb', 'is', 'bs', 'yo', 'an',
            'mg', 'bpy', 'bn', 'io', 'fy', 'lmo', 'sw', 'gu', 'ml', 'pnb', 'af',
            'nds', 'scn', 'ur', 'ku', 'zh-yue', 'qu', 'ne', 'hy', 'su', 'diq',
            'ast', 'nap', 'ga', 'cv', 'bat-smg', 'tt', 'wa', 'am', 'kn', 'als',
            'bug', 'zh-min-nan', 'ia', 'tg', 'vec', 'yi', 'roa-tara', 'gd',
            'os', 'arz', 'sah', 'uz', 'my', 'pam', 'sco', 'nah', 'hsb', 'mi',
            'mn', 'li', 'sa', 'co', 'gan', 'glk', 'ba', 'si', 'hif', 'bcl',
            'fo', 'mrj', 'bar', 'ckb', 'fiu-vro', 'nds-nl', 'tk', 'vls', 'gv',
            'ilo', 'se', 'map-bms', 'dv', 'nrm', 'pag', 'pa', 'rm', 'mzn', 'bo',
            'ps', 'rue', 'udm', 'km', 'fur', 'csb', 'wuu', 'mt', 'ug', 'lij',
            'koi', 'pi', 'kv', 'ang', 'ky', 'bh', 'mhr', 'sc', 'lad', 'nov',
            'zh-classical', 'ksh', 'cbk-zam', 'hak', 'so', 'kw', 'nv', 'frp',
            'szl', 'ext', 'stq', 'ie', 'xal', 'rw', 'haw', 'ln', 'pdc', 'or',
            'pcd', 'pfl', 'krc', 'frr', 'to', 'crh', 'ace', 'eml', 'gn', 'myv',
            'ay', 'arc', 'kl', 'ce', 'pap', 'bjn', 'lbe', 'gag', 'tpi', 'jbo',
            'wo', 'mdf', 'zea', 'av', 'kab', 'ty', 'dsb', 'srn', 'xmf', 'lo',
            'ab', 'as', 'ig', 'na', 'tet', 'sn', 'mwl', 'kg', 'kaa', 'rmy',
            'ltg', 'cu', 'kbd', 'sm', 'ks', 'sd', 'bi', 'bm', 'iu', 'ik', 'ss',
            'pih', 'pnt', 'za', 'chr', 'cdo', 'got', 'ee', 'ha', 'zu', 'ti',
            'bxr', 'om', 've', 'ts', 'sg', 'rn', 'cr', 'dz', 'tum', 'tn', 'fj',
            'lg', 'ch', 'ak', 'ny', 'ff', 'st', 'chy', 'xh', 'ki', 'tw', 'nso',
        ]
