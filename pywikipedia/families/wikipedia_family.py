...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'ca', 'no', 'fi', 'uk', 'cs', 'hu', 'ro', 'ko', 'vi', 'tr',
            'id', 'da', 'ar', 'eo', 'sr', 'lt', 'sk', 'vo', 'fa', 'he', 'bg',
            'sl', 'ms', 'war', 'hr', 'et', 'new', 'simple', 'gl', 'hi', 'th',
            'eu', 'nn', 'roa-rup', 'el', 'ht', 'az', 'tl', 'la', 'te', 'ka',
            'mk', 'ceb', 'sh', 'br', 'pms', 'mr', 'lv', 'lb', 'be-x-old', 'jv',
            ...
            'tt', 'zh-min-nan', 'als', 'os', 'uz', 'pam', 'sah', 'kk', 'arz',
            'mi', 'am', 'li', 'nah', 'hsb', 'glk', 'co', 'gan', 'mn', 'sco',
            'ia', 'bcl', 'my', 'fo', 'fiu-vro', 'nds-nl', 'si', 'tk', 'vls',
            'sa', 'bar', 'mg', 'gv', 'ilo', 'dv', 'nrm', 'pag', 'map-bms',
            'ckb', 'rm', 'se', 'diq', 'mzn', 'wuu', 'fur', 'ug', 'lij', 'mt',
            'bh', 'bo', 'nov', 'ang', 'csb', 'sc', 'zh-classical', 'hif', 'km',
            'lad', 'cbk-zam', 'pi', 'frp', 'ps', 'hak', 'kw', 'pa', 'nv', 'szl',
            'xal', 'pdc', 'haw', 'stq', 'ie', 'so', 'kv', 'krc', 'crh', 'to',
            'ace', 'mhr', 'rw', 'pcd', 'myv', 'ln', 'ext', 'gn', 'ky', 'eml',
            'arc', 'pap', 'ay', 'ce', 'jbo', 'wo', 'bjn', 'ba', 'frr',
            'kl', 'udm', 'tpi', 'kab', 'ty', 'srn', 'zea', 'mrj', 'gag', 'koi',
            'dsb', 'ab', 'ig', 'or', 'lo', 'kg', 'mdf', 'av', 'mwl', 'rmy',
            'cu', 'kaa', 'sm', 'tet', 'got', 'ks', 'bm', 'ik', 'sd', 'bi',
            'lbe', 'na', 'pih', 'iu', 'pnt', 'as', 'pfl', 'chr', 'cdo', 'ss',
            'ha', 'ee', 'ti', 'om', 'zu', 'za', 've', 'ts', 'rn', 'cr', 'sg',
            'dz', 'ch', 'lg', 'bug', 'bxr', 'fj', 'ny', 'ak', 'st', 'xh', 'ff',
            'tn', 'ki', 'tum', 'sn', 'tw', 'chy',
        ]
