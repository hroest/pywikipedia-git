...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'roa-rup', 'eu', 'hi', 'el', 'ht', 'la', 'te', 'tl', 'ka', 'ceb',
            ...
            'kk', 'mi', 'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'am', 'mn',
            'ia', 'bcl', 'sco', 'fo', 'fiu-vro', 'nds-nl', 'si', 'tk', 'vls',
            'sa', 'my', 'mg', 'bar', 'gv', 'dv', 'ilo', 'nrm', 'rm', 'pag',
            'map-bms', 'diq', 'ckb', 'se', 'mzn', 'wuu', 'ug', 'fur', 'lij',
            'mt', 'bh', 'nov', 'ang', 'csb', 'sc', 'zh-classical', 'km', 'lad',
            'bo', 'cbk-zam', 'pi', 'hif', 'frp', 'hak', 'kw', 'ps', 'pa', 'szl',
            'xal', 'pdc', 'haw', 'nv', 'stq', 'ie', 'kv', 'fj', 'crh', 'so',
            'to', 'ace', 'myv', 'mhr', 'gn', 'krc', 'ext', 'ln', 'ky', 'eml',
            'pcd', 'arc', 'ay', 'jbo', 'wo', 'ba', 'frr', 'pap', 'kab', 'tpi',
            'ty', 'bjn', 'srn', 'zea', 'kl', 'udm', 'ce', 'koi', 'mrj', 'ig',
            'dsb', 'or', 'kg', 'lo', 'ab', 'mdf', 'rmy', 'mwl', 'cu', 'kaa',
            'sm', 'tet', 'av', 'ks', 'got', 'bm', 'sd', 'na', 'pih', 'ik',
            'pnt', 'iu', 'chr', 'bi', 'as', 'cdo', 'ss', 'ee', 'zu', 'om', 'za',
            'ti', 'ts', 've', 'ha', 'dz', 'sg', 'ch', 'cr', 'ak', 'xh', 'rw',
            'bug', 'st', 'tn', 'ki', 'bxr', 'ny', 'lbe', 'tw', 'sn', 'rn', 'ff',
            'chy', 'tum', 'lg', 'gag', 'pfl',
        ]
