...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ro', 'fa', 'ar', 'da', 'eo', 'sr', 'lt', 'sk', 'he', 'ms', 'sl',
            'bg', 'vo', 'eu', 'war', 'hr', 'hi', 'et', 'az', 'gl', 'simple',
            'nn', 'new', 'th', 'kk', 'el', 'roa-rup', 'la', 'tl', 'ht', 'ka',
            'te', 'mk', 'sh', 'ceb', 'pms', 'br', 'be-x-old', 'lv', 'jv', 'ta',
            'nap', 'mr', 'sq', 'cy', 'lb', 'is', 'bs', 'be', 'oc', 'yo', 'an',
            'bpy', 'mg', 'bn', 'io', 'sw', 'lmo', 'fy', 'gu', 'ml', 'af', 'pnb',
            'nds', 'scn', 'ur', 'qu', 'ku', 'zh-yue', 'ne', 'ast', 'su', 'hy',
            'ga', 'bat-smg', 'cv', 'wa', 'tt', 'am', 'diq', 'kn', 'als', 'tg',
            'bug', 'zh-min-nan', 'vec', 'roa-tara', 'yi', 'gd', 'os', 'uz',
            'sah', 'arz', 'pam', 'sco', 'mi', 'hsb', 'nah', 'li', 'mn', 'my',
            'co', 'gan', 'glk', 'ia', 'hif', 'bcl', 'fo', 'si', 'sa', 'mrj',
            'fiu-vro', 'nds-nl', 'ckb', 'bar', 'vls', 'tk', 'gv', 'ilo', 'se',
            'map-bms', 'dv', 'nrm', 'pag', 'rm', 'mzn', 'bo', 'udm', 'fur',
            'ps', 'wuu', 'ug', 'km', 'csb', 'mt', 'lij', 'pi', 'koi', 'bh',
            'ang', 'kv', 'sc', 'lad', 'nov', 'zh-classical', 'mhr', 'cbk-zam',
            'ksh', 'rue', 'so', 'kw', 'frp', 'hak', 'nv', 'pa', 'szl', 'ext',
            'xal', 'ie', 'stq', 'rw', 'haw', 'ln', 'pdc', 'krc', 'pcd', 'to',
            'ky', 'crh', 'ace', 'eml', 'myv', 'gn', 'ba', 'or', 'ce', 'arc',
            'kl', 'ay', 'frr', 'pap', 'bjn', 'pfl', 'jbo', 'wo', 'lbe', 'tpi',
            'mdf', 'kab', 'gag', 'ty', 'srn', 'zea', 'dsb', 'lo', 'ab', 'xmf',
            'ig', 'av', 'tet', 'kg', 'mwl', 'na', 'kaa', 'rmy', 'ltg', 'cu',
            'kbd', 'as', 'sm', 'sd', 'bm', 'bi', 'ik', 'ss', 'pih', 'ks', 'iu',
            'pnt', 'cdo', 'chr', 'ee', 'got', 'ha', 'za', 'ti', 'bxr', 'om',
            'zu', 've', 'ts', 'rn', 'sg', 'cr', 'dz', 'tum', 'sn', 'lg', 'ch',
            'fj', 'ny', 'st', 'xh', 'ff', 'tn', 'chy', 'ki', 'ak', 'tw',
        ]
