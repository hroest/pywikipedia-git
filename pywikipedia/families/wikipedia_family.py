...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'ca', 'no', 'uk', 'fi', 'vi', 'cs', 'hu', 'ko', 'tr', 'id',
            'ro', 'fa', 'ar', 'da', 'eo', 'sr', 'lt', 'sk', 'he', 'ms', 'bg',
            'sl', 'vo', 'eu', 'war', 'hr', 'hi', 'et', 'az', 'kk', 'gl',
            'simple', 'nn', 'new', 'th', 'el', 'roa-rup', 'la', 'tl', 'ht',
            'ka', 'te', 'mk', 'sh', 'ceb', 'pms', 'br', 'be-x-old', 'lv', 'jv',
            'ta', 'mr', 'cy', 'sq', 'lb', 'is', 'be', 'bs', 'oc', 'yo', 'an',
            ...
            'os', 'uz', 'sah', 'pam', 'sco', 'mi', 'my', 'hsb', 'nah', 'li',
            'mn', 'co', 'gan', 'glk', 'ia', 'hif', 'bcl', 'sa', 'si', 'fo',
            'mrj', 'fiu-vro', 'ckb', 'nds-nl', 'bar', 'vls', 'tk', 'gv', 'ilo',
            'se', 'map-bms', 'dv', 'nrm', 'pag', 'rm', 'mzn', 'bo', 'udm',
            'fur', 'ps', 'wuu', 'km', 'ug', 'mt', 'csb', 'lij', 'koi', 'pi',
            'bh', 'ang', 'kv', 'sc', 'lad', 'nov', 'zh-classical', 'mhr',
            'cbk-zam', 'ksh', 'rue', 'so', 'kw', 'frp', 'nv', 'hak', 'pa',
            'szl', 'ext', 'stq', 'ie', 'xal', 'rw', 'haw', 'ln', 'pdc', 'pcd',
            'pfl', 'krc', 'to', 'ky', 'crh', 'ace', 'myv', 'eml', 'or', 'gn',
            'ba', 'ce', 'ay', 'frr', 'arc', 'kl', 'pap', 'bjn', 'jbo', 'lbe',
            'wo', 'tpi', 'mdf', 'kab', 'gag', 'ty', 'srn', 'zea', 'dsb', 'lo',
            'xmf', 'ab', 'av', 'ig', 'na', 'tet', 'kg', 'mwl', 'kaa', 'as',
            'rmy', 'ltg', 'cu', 'kbd', 'sm', 'sd', 'bm', 'bi', 'ik', 'ss', 'iu',
            'pih', 'ks', 'pnt', 'chr', 'cdo', 'za', 'ee', 'got', 'ha', 'ti',
