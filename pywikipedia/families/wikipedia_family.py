...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'ca', 'no', 'uk', 'fi', 'cs', 'vi', 'hu', 'ko', 'ro', 'id',
            'tr', 'da', 'ar', 'eo', 'sr', 'lt', 'sk', 'fa', 'vo', 'he', 'bg',
            'ms', 'sl', 'war', 'hr', 'et', 'hi', 'new', 'gl', 'simple', 'th',
            'eu', 'nn', 'roa-rup', 'el', 'az', 'ht', 'tl', 'la', 'te', 'ka',
            'mk', 'ceb', 'sh', 'br', 'pms', 'be-x-old', 'lv', 'mr', 'jv', 'lb',
            'cy', 'sq', 'bs', 'is', 'ta', 'be', 'bpy', 'an', 'oc', 'bn', 'io',
            'sw', 'lmo', 'fy', 'gu', 'af', 'nds', 'ml', 'scn', 'ur', 'qu', 'ku',
            'zh-yue', 'su', 'ast', 'hy', 'nap', 'bat-smg', 'yo', 'ga', 'cv',
            'wa', 'ne', 'pnb', 'kn', 'ksh', 'tg', 'roa-tara', 'vec', 'tt', 'kk',
            'yi', 'gd', 'als', 'zh-min-nan', 'os', 'uz', 'pam', 'sah', 'arz',
            'am', 'mi', 'li', 'nah', 'hsb', 'sco', 'gan', 'co', 'glk', 'mn',
            'bug', 'ia', 'my', 'bcl', 'fo', 'fiu-vro', 'nds-nl', 'si', 'vls',
            'tk', 'sa', 'bar', 'mg', 'gv', 'ilo', 'dv', 'nrm', 'map-bms', 'pag',
            'ckb', 'diq', 'rm', 'se', 'mzn', 'wuu', 'fur', 'ug', 'lij', 'mt',
            'bo', 'bh', 'ang', 'nov', 'csb', 'hif', 'sc', 'zh-classical', 'lad',
            'km', 'cbk-zam', 'pi', 'ps', 'frp', 'hak', 'kw', 'rue', 'pa', 'nv',
            'szl', 'xal', 'pdc', 'haw', 'stq', 'ie', 'udm', 'so', 'mhr', 'to',
            'kv', 'rw', 'krc', 'crh', 'ln', 'ace', 'pcd', 'mrj', 'myv', 'ext',
            'gn', 'ky', 'ce', 'eml', 'ba', 'arc', 'pap', 'ay', 'jbo', 'wo',
            'bjn', 'frr', 'kl', 'tpi', 'kab', 'ty', 'srn', 'zea', 'gag', 'ab',
            'dsb', 'koi', 'lo', 'or', 'ig', 'av', 'kg', 'mdf', 'tet', 'mwl',
            'rmy', 'cu', 'lbe', 'kaa', 'sm', 'got', 'ks', 'bm', 'ik', 'sd',
            'bi', 'as', 'pfl', 'na', 'pih', 'pnt', 'iu', 'ss', 'chr', 'cdo',
            'ha', 'ee', 'ti', 'om', 'zu', 'za', 've', 'ts', 'bxr', 'sg', 'rn',
            'dz', 'cr', 'ch', 'lg', 'fj', 'tum', 'ny', 'st', 'ak', 'xh', 'ff',
            'tn', 'ki', 'sn', 'tw', 'chy',
        ]
