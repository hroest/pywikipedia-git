...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'az', 'br', 'sh', 'lb', 'bs', 'jv', 'is', 'mr', 'lv', 'cy', 'tl',
            ...
            'kw', 'hif', 'bo', 'ckb', 'hak', 'pdc', 'haw', 'szl', 'pa', 'ps',
            'ie', 'xal', 'kv', 'crh', 'to', 'stq', 'myv', 'ace', 'gn', 'ln',
            'krc', 'nv', 'ky', 'mhr', 'cbk-zam', 'ext', 'arc', 'jbo', 'wo',
            'ty', 'eml', 'kab', 'tpi', 'so', 'pap', 'zea', 'fj', 'srn', 'ay',
            'ba', 'ig', 'or', 'dsb', 'ce', 'kl', 'kg', 'udm', 'lo', 'rmy', 'cu',
            'ab', 'mwl', 'kaa', 'pcd', 'sm', 'av', 'ks', 'tet', 'got', 'mdf',
