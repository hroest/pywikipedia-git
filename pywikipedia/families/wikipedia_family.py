...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ro', 'fa', 'ar', 'da', 'eo', 'sr', 'lt', 'sk', 'ms', 'he', 'kk',
            'bg', 'sl', 'vo', 'eu', 'war', 'hr', 'hi', 'et', 'az', 'gl',
            'simple', 'nn', 'th', 'new', 'el', 'la', 'roa-rup', 'oc', 'tl',
            'mk', 'ka', 'ht', 'sh', 'pms', 'te', 'ta', 'ceb', 'be-x-old', 'br',
            'sq', 'lv', 'jv', 'be', 'mr', 'lb', 'cy', 'is', 'bs', 'yo', 'mg',
            'an', 'bpy', 'lmo', 'fy', 'sw', 'bn', 'io', 'gu', 'ml', 'pnb', 'af',
            'nds', 'ne', 'scn', 'ur', 'hy', 'ku', 'zh-yue', 'qu', 'su', 'diq',
            'ast', 'tt', 'ga', 'nap', 'cv', 'bat-smg', 'wa', 'am', 'kn', 'ia',
            'als', 'bug', 'my', 'zh-min-nan', 'tg', 'vec', 'yi', 'roa-tara',
            'gd', 'os', 'arz', 'nah', 'sah', 'sco', 'uz', 'pam', 'mn', 'hsb',
            'sa', 'mi', 'li', 'map-bms', 'co', 'ba', 'gan', 'si', 'glk', 'hif',
            'bcl', 'fo', 'mrj', 'bo', 'bar', 'ckb', 'fiu-vro', 'nds-nl', 'ky',
            'ilo', 'tk', 'vls', 'gv', 'se', 'dv', 'nrm', 'rue', 'pag', 'pa',
            'rm', 'mzn', 'km', 'ps', 'udm', 'fur', 'csb', 'wuu', 'mt', 'ug',
            'lij', 'koi', 'pi', 'kv', 'ang', 'mhr', 'bh', 'lad', 'sc', 'nov',
            'zh-classical', 'ksh', 'cbk-zam', 'so', 'hak', 'nv', 'kw', 'frp',
            'stq', 'ext', 'szl', 'ie', 'or', 'xal', 'pcd', 'haw', 'rw', 'ln',
            'pdc', 'frr', 'pfl', 'xmf', 'krc', 'to', 'ace', 'crh', 'ce', 'eml',
            'ay', 'gn', 'myv', 'arc', 'kl', 'gag', 'pap', 'bjn', 'lbe', 'tpi',
            'wo', 'jbo', 'zea', 'mdf', 'av', 'kab', 'as', 'dsb', 'ty', 'sn',
            'srn', 'lo', 'ab', 'ig', 'na', 'tet', 'kg', 'mwl', 'kaa', 'nso',
            'ltg', 'rmy', 'cu', 'kbd', 'sm', 'tn', 'sd', 'bi', 'bm', 'ik', 'iu',
            'ss', 'pih', 'za', 'pnt', 'chr', 'cdo', 'got', 'ee', 'ha', 'zu',
            'ti', 'ks', 'bxr', 'om', 've', 'ts', 'sg', 'rn', 'dz', 'cr', 'ak',
            'tum', 'lg', 'fj', 'ch', 'chy', 'ny', 'st', 'ff', 'tw', 'xh', 'ki',
        ]
