...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'ca', 'no', 'uk', 'fi', 'vi', 'cs', 'hu', 'ko', 'id', 'tr',
            'ro', 'da', 'ar', 'eo', 'sr', 'lt', 'fa', 'sk', 'vo', 'ms', 'he',
            'bg', 'sl', 'war', 'hr', 'hi', 'et', 'gl', 'simple', 'new', 'th',
            'eu', 'nn', 'roa-rup', 'el', 'az', 'ht', 'la', 'tl', 'ka', 'te',
            'mk', 'ceb', 'sh', 'pms', 'br', 'be-x-old', 'lv', 'mr', 'jv', 'lb',
            'cy', 'sq', 'is', 'bs', 'ta', 'be', 'an', 'bpy', 'oc', 'bn', 'io',
            'sw', 'lmo', 'fy', 'gu', 'kk', 'ml', 'af', 'nds', 'scn', 'ur', 'qu',
            'ku', 'zh-yue', 'su', 'ast', 'hy', 'nap', 'ne', 'yo', 'bat-smg',
            'cv', 'ga', 'wa', 'pnb', 'kn', 'tg', 'roa-tara', 'vec', 'tt', 'als',
            'yi', 'zh-min-nan', 'gd', 'bug', 'os', 'uz', 'sah', 'pam', 'arz',
            'am', 'mi', 'li', 'hsb', 'nah', 'sco', 'gan', 'co', 'glk', 'mn',
            'my', 'ia', 'bcl', 'fo', 'fiu-vro', 'si', 'nds-nl', 'vls', 'tk',
            'sa', 'bar', 'ckb', 'mg', 'gv', 'ilo', 'map-bms', 'dv', 'nrm',
            'pag', 'diq', 'se', 'rm', 'mzn', 'wuu', 'fur', 'ug', 'lij', 'mt',
            'bo', 'bh', 'hif', 'ang', 'csb', 'nov', 'lad', 'km', 'sc',
            'zh-classical', 'mrj', 'cbk-zam', 'pi', 'ps', 'ksh', 'frp', 'hak',
            'kw', 'rue', 'mhr', 'nv', 'pa', 'szl', 'xal', 'rw', 'so', 'haw',
            'ie', 'pdc', 'stq', 'udm', 'ln', 'kv', 'krc', 'to', 'crh', 'pcd',
            'ace', 'ky', 'ext', 'myv', 'gn', 'ba', 'ce', 'eml', 'arc', 'pap',
            'ay', 'bjn', 'kl', 'jbo', 'wo', 'frr', 'tpi', 'kab', 'ty', 'srn',
            'zea', 'gag', 'ab', 'dsb', 'or', 'koi', 'lo', 'ig', 'av', 'mdf',
            'tet', 'kg', 'mwl', 'rmy', 'lbe', 'cu', 'ltg', 'kaa', 'kbd', 'sm',
            'got', 'ks', 'bm', 'pfl', 'ik', 'sd', 'bi', 'as', 'iu', 'na', 'pih',
            'pnt', 'ss', 'cdo', 'chr', 'ha', 'ee', 'ti', 'zu', 'bxr', 'om',
            'za', 've', 'ts', 'rn', 'sg', 'dz', 'cr', 'ch', 'lg', 'fj', 'ny',
            'tum', 'st', 'xh', 'ff', 'tn', 'ki', 'sn', 'ak', 'tw', 'chy',
        ]
