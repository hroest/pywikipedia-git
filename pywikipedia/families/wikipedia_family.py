...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'bg', 'sl', 'war', 'eu', 'hi', 'hr', 'et', 'gl', 'simple', 'new',
            'nn', 'th', 'az', 'el', 'roa-rup', 'la', 'ht', 'tl', 'ka', 'te',
            'mk', 'sh', 'ceb', 'nap', 'pms', 'br', 'be-x-old', 'lv', 'mr', 'jv',
            'kk', 'ta', 'sq', 'lb', 'cy', 'is', 'bs', 'be', 'oc', 'an', 'bpy',
            'bn', 'io', 'sw', 'lmo', 'fy', 'gu', 'mg', 'ml', 'af', 'nds', 'scn',
            'ur', 'qu', 'ku', 'zh-yue', 'ne', 'ast', 'su', 'pnb', 'yo', 'hy',
            'bat-smg', 'ga', 'cv', 'wa', 'kn', 'am', 'als', 'diq', 'tg', 'vec',
            'roa-tara', 'tt', 'zh-min-nan', 'yi', 'bug', 'gd', 'os', 'uz',
            'sah', 'pam', 'arz', 'mi', 'li', 'hsb', 'sco', 'nah', 'mn', 'co',
            'my', 'gan', 'glk', 'ia', 'hif', 'bcl', 'fo', 'sa', 'si', 'fiu-vro',
            'nds-nl', 'vls', 'bar', 'tk', 'ckb', 'mrj', 'gv', 'ilo', 'se',
            'map-bms', 'dv', 'nrm', 'pag', 'rm', 'mzn', 'bo', 'wuu', 'fur',
            'ug', 'mt', 'lij', 'csb', 'km', 'bh', 'ang', 'ps', 'udm', 'lad',
            'nov', 'sc', 'zh-classical', 'mhr', 'cbk-zam', 'pi', 'kv', 'ksh',
            'koi', 'frp', 'rue', 'hak', 'so', 'kw', 'nv', 'pa', 'szl', 'xal',
            'ie', 'rw', 'stq', 'haw', 'pdc', 'ln', 'krc', 'ext', 'to', 'pcd',
            'crh', 'ky', 'ace', 'myv', 'gn', 'ba', 'eml', 'ce', 'arc', 'kl',
            'pap', 'ay', 'frr', 'bjn', 'or', 'pfl', 'jbo', 'wo', 'tpi', 'kab',
            'ty', 'gag', 'srn', 'zea', 'dsb', 'ab', 'lo', 'ig', 'mdf', 'tet',
            'av', 'kg', 'mwl', 'rmy', 'ltg', 'cu', 'lbe', 'kaa', 'na', 'kbd',
            'sm', 'got', 'bm', 'as', 'ik', 'bi', 'sd', 'ss', 'iu', 'ks', 'pih',
            'pnt', 'chr', 'cdo', 'ee', 'ha', 'ti', 'za', 'bxr', 'om', 'zu',
