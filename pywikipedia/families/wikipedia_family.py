...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            'en', 'de', 'fr', 'pl', 'it', 'es', 'ja', 'ru', 'pt', 'nl', 'sv',
            ...
            'zh-yue', 'su', 'ast', 'hy', 'nap', 'yo', 'bat-smg', 'ne', 'cv',
            'ga', 'wa', 'pnb', 'kn', 'tg', 'kk', 'roa-tara', 'vec', 'tt', 'yi',
            'als', 'zh-min-nan', 'gd', 'os', 'uz', 'pam', 'sah', 'arz', 'am',
            'bug', 'mi', 'li', 'hsb', 'nah', 'sco', 'gan', 'co', 'glk', 'mn',
            'my', 'ia', 'bcl', 'fo', 'fiu-vro', 'si', 'nds-nl', 'vls', 'tk',
            'sa', 'bar', 'mg', 'gv', 'ilo', 'map-bms', 'dv', 'nrm', 'pag',
            'ckb', 'diq', 'rm', 'se', 'mzn', 'wuu', 'fur', 'ug', 'lij', 'mt',
            'bo', 'bh', 'hif', 'ang', 'nov', 'csb', 'lad', 'sc', 'zh-classical',
            'km', 'cbk-zam', 'pi', 'ps', 'frp', 'hak', 'mrj', 'kw', 'ksh',
            'rue', 'nv', 'pa', 'szl', 'xal', 'pdc', 'haw', 'stq', 'ie', 'udm',
            'so', 'mhr', 'rw', 'kv', 'to', 'krc', 'ln', 'crh', 'pcd', 'ace',
            'myv', 'ext', 'ky', 'gn', 'ce', 'ba', 'eml', 'arc', 'pap', 'ay',
            'bjn', 'jbo', 'kl', 'wo', 'frr', 'tpi', 'kab', 'ty', 'srn', 'zea',
            'gag', 'ab', 'dsb', 'koi', 'or', 'lo', 'ig', 'av', 'kg', 'mdf',
            'tet', 'mwl', 'lbe', 'rmy', 'cu', 'ltg', 'kaa', 'sm', 'kbd', 'got',
            'ks', 'bm', 'ik', 'sd', 'bi', 'pfl', 'as', 'na', 'pih', 'iu', 'pnt',
            'ss', 'cdo', 'chr', 'ha', 'ee', 'ti', 'bxr', 'om', 'zu', 'za', 've',
            'ts', 'rn', 'sg', 'dz', 'cr', 'ch', 'lg', 'fj', 'tum', 'ny', 'st',
            'ak', 'xh', 'ff', 'tn', 'ki', 'sn', 'tw', 'chy',
        ]
