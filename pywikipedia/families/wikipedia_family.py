...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'an', 'bpy', 'lmo', 'fy', 'sw', 'bn', 'io', 'ml', 'gu', 'af', 'pnb',
            'hy', 'ne', 'nds', 'scn', 'ur', 'ku', 'zh-yue', 'su', 'qu', 'diq',
            'ba', 'ast', 'tt', 'ga', 'nap', 'ia', 'cv', 'bat-smg', 'map-bms',
            'wa', 'am', 'kn', 'als', 'bug', 'my', 'zh-min-nan', 'tg', 'vec',
            'yi', 'roa-tara', 'gd', 'hif', 'os', 'arz', 'nah', 'sco', 'sah',
            'uz', 'pam', 'sa', 'mn', 'hsb', 'mi', 'li', 'si', 'co', 'gan',
            'glk', 'bcl', 'fo', 'ckb', 'bar', 'bo', 'mrj', 'ky', 'fiu-vro',
            'ilo', 'nds-nl', 'tk', 'vls', 'se', 'gv', 'dv', 'nrm', 'rue', 'pag',
            'pa', 'rm', 'mzn', 'ps', 'km', 'udm', 'fur', 'csb', 'mt', 'wuu',
            'ug', 'lij', 'koi', 'mhr', 'kv', 'pi', 'ang', 'lad', 'bh', 'sc',
            'zea', 'zh-classical', 'nov', 'ksh', 'cbk-zam', 'so', 'nv', 'hak',
            'kw', 'frp', 'stq', 'or', 'szl', 'ext', 'ie', 'pcd', 'xal', 'xmf',
            'haw', 'rw', 'frr', 'ln', 'pdc', 'ay', 'pfl', 'krc', 'to', 'ace',
            'eml', 'crh', 'ce', 'gn', 'myv', 'kl', 'arc', 'pap', 'gag', 'bjn',
            'lbe', 'tpi', 'wo', 'jbo', 'as', 'mdf', 'av', 'dsb', 'kab', 'ty',
            'sn', 'srn', 'lo', 'ab', 'ig', 'na', 'kg', 'tet', 'mwl', 'ltg',
            'nso', 'kaa', 'rmy', 'cu', 'tn', 'kbd', 'sm', 'sd', 'bi', 'bm',
            'ik', 'ss', 'iu', 'pih', 'za', 'chr', 'pnt', 'got', 'cdo', 'ee',
            'ha', 'zu', 'ti', 'ks', 'bxr', 'om', 've', 'ts', 'sg', 'rn', 'cr',
            'dz', 'ny', 'fj', 'ak', 'tum', 'lg', 'chy', 'ch', 'st', 'tw', 'ff',
            'xh', 'ki',
        ]
