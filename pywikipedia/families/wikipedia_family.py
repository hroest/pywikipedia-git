...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'bg', 'sl', 'war', 'hr', 'hi', 'eu', 'et', 'gl', 'simple', 'new',
            'th', 'nn', 'roa-rup', 'el', 'az', 'ht', 'la', 'tl', 'ka', 'te',
            'mk', 'ceb', 'sh', 'pms', 'br', 'be-x-old', 'lv', 'mr', 'jv', 'lb',
            'cy', 'sq', 'is', 'ta', 'bs', 'be', 'an', 'oc', 'bpy', 'bn', 'io',
            'kk', 'sw', 'lmo', 'fy', 'gu', 'ml', 'af', 'nds', 'ur', 'scn', 'qu',
            'nap', 'ku', 'zh-yue', 'su', 'ast', 'hy', 'ne', 'yo', 'bat-smg',
            'ga', 'cv', 'wa', 'pnb', 'kn', 'tg', 'vec', 'roa-tara', 'tt', 'als',
            'zh-min-nan', 'yi', 'bug', 'gd', 'os', 'uz', 'sah', 'pam', 'am',
            'arz', 'mi', 'li', 'hsb', 'nah', 'sco', 'mn', 'gan', 'co', 'glk',
            'my', 'mg', 'ia', 'bcl', 'fo', 'fiu-vro', 'si', 'nds-nl', 'sa',
            'vls', 'tk', 'bar', 'ckb', 'gv', 'ilo', 'map-bms', 'dv', 'nrm',
            'pag', 'diq', 'rm', 'se', 'mzn', 'mrj', 'wuu', 'fur', 'ug', 'lij',
            'mt', 'bo', 'bh', 'hif', 'csb', 'ang', 'nov', 'lad', 'km', 'sc',
            'zh-classical', 'cbk-zam', 'pi', 'udm', 'ps', 'ksh', 'frp', 'hak',
            'mhr', 'rue', 'kw', 'nv', 'pa', 'szl', 'so', 'xal', 'rw', 'ie',
            'haw', 'stq', 'pdc', 'kv', 'ln', 'krc', 'to', 'pcd', 'crh', 'ace',
            'ky', 'ext', 'myv', 'gn', 'ba', 'eml', 'ce', 'arc', 'pap', 'ay',
            'bjn', 'kl', 'frr', 'jbo', 'wo', 'tpi', 'kab', 'ty', 'srn', 'zea',
            'gag', 'or', 'dsb', 'koi', 'ab', 'lo', 'ig', 'av', 'tet', 'mdf',
            'kg', 'mwl', 'rmy', 'lbe', 'cu', 'ltg', 'kaa', 'kbd', 'sm', 'got',
            'ks', 'bm', 'pfl', 'ik', 'sd', 'bi', 'as', 'na', 'iu', 'pih', 'pnt',
