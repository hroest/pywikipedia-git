...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ka', 'mk', 'ht', 'sh', 'pms', 'te', 'ta', 'ceb', 'be-x-old', 'br',
            'sq', 'lv', 'jv', 'be', 'mr', 'cy', 'lb', 'is', 'bs', 'yo', 'mg',
            'an', 'bpy', 'lmo', 'fy', 'bn', 'sw', 'io', 'ml', 'gu', 'pnb', 'af',
            'ne', 'nds', 'hy', 'scn', 'ur', 'ku', 'zh-yue', 'qu', 'su', 'diq',
            'ast', 'tt', 'ga', 'nap', 'cv', 'bat-smg', 'wa', 'am', 'kn', 'ia',
            'als', 'bug', 'my', 'zh-min-nan', 'tg', 'vec', 'yi', 'roa-tara',
            'gd', 'os', 'arz', 'nah', 'sah', 'sco', 'uz', 'pam', 'map-bms',
            'mn', 'sa', 'hsb', 'mi', 'li', 'hif', 'co', 'ba', 'si', 'gan',
            'glk', 'fo', 'bcl', 'bo', 'bar', 'mrj', 'ckb', 'fiu-vro', 'nds-nl',
            'ilo', 'ky', 'tk', 'vls', 'se', 'gv', 'dv', 'nrm', 'rue', 'pag',
            'pa', 'rm', 'mzn', 'km', 'ps', 'udm', 'fur', 'csb', 'wuu', 'mt',
            'ug', 'lij', 'koi', 'pi', 'kv', 'ang', 'mhr', 'lad', 'bh', 'sc',
            'nov', 'zh-classical', 'ksh', 'cbk-zam', 'so', 'hak', 'nv', 'kw',
            'frp', 'stq', 'szl', 'ext', 'or', 'ie', 'pcd', 'xal', 'haw', 'rw',
            'xmf', 'ln', 'pdc', 'frr', 'pfl', 'krc', 'to', 'ace', 'ay', 'crh',
            'eml', 'ce', 'gn', 'myv', 'arc', 'kl', 'pap', 'gag', 'bjn', 'lbe',
            'tpi', 'wo', 'jbo', 'zea', 'mdf', 'av', 'as', 'kab', 'dsb', 'ty',
            'sn', 'srn', 'lo', 'ab', 'ig', 'na', 'tet', 'mwl', 'kg', 'kaa',
            'nso', 'ltg', 'rmy', 'cu', 'kbd', 'tn', 'sm', 'sd', 'bi', 'bm',
            'ik', 'ss', 'iu', 'pih', 'za', 'pnt', 'chr', 'cdo', 'got', 'ee',
            'ha', 'zu', 'ti', 'ks', 'bxr', 'om', 've', 'ts', 'sg', 'rn', 'dz',
            'cr', 'fj', 'ak', 'tum', 'lg', 'ch', 'chy', 'ny', 'st', 'ff', 'tw',
            'xh', 'ki',
        ]
