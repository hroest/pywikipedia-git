...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ia', 'mn', 'bcl', 'fiu-vro', 'nds-nl', 'fo', 'tk', 'vls', 'si',
            'sa', 'sco', 'bar', 'gv', 'dv', 'nrm', 'pag', 'rm', 'my', 'map-bms',
            ...
            'ace', 'so', 'nv', 'myv', 'gn', 'krc', 'ln', 'ext', 'ky', 'mhr',
            'arc', 'eml', 'jbo', 'wo', 'ay', 'pcd', 'kab', 'frr', 'ty', 'tpi',
            'ba', 'pap', 'zea', 'srn', 'kl', 'udm', 'ce', 'ig', 'or', 'dsb',
            'kg', 'lo', 'ab', 'rmy', 'tum', 'mwl', 'cu', 'mdf', 'kaa', 'sm',
