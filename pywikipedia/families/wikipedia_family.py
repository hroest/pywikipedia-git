...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'no', 'ca', 'fi', 'uk', 'cs', 'hu', 'ro', 'tr', 'ko', 'da',
            'eo', 'ar', 'id', 'vi', 'vo', 'sr', 'sk', 'lt', 'he', 'bg', 'fa',
            'sl', 'war', 'hr', 'et', 'new', 'ms', 'simple', 'th', 'gl', 'nn',
            'eu', 'hi', 'roa-rup', 'el', 'ht', 'te', 'ka', 'mk', 'ceb', 'la',
            'az', 'br', 'sh', 'mr', 'jv', 'lb', 'bs', 'tl', 'is', 'lv', 'cy',
            'pms', 'sq', 'be-x-old', 'bpy', 'ta', 'oc', 'an', 'bn', 'be', 'io',
            'sw', 'fy', 'nds', 'scn', 'lmo', 'af', 'gu', 'qu', 'su', 'zh-yue',
            'ur', 'ast', 'ku', 'ml', 'nap', 'bat-smg', 'wa', 'cv', 'ga', 'ksh',
            'hy', 'tg', 'yo', 'kn', 'roa-tara', 'vec', 'gd', 'yi', 'uz', 'pam',
            'zh-min-nan', 'os', 'tt', 'sah', 'mi', 'als', 'arz', 'kk', 'nah',
            'li', 'hsb', 'glk', 'ne', 'co', 'gan', 'ia', 'pnb', 'bcl', 'mn',
            'fiu-vro', 'nds-nl', 'vls', 'fo', 'am', 'tk', 'sa', 'si', 'bar',
            'dv', 'nrm', 'gv', 'pag', 'rm', 'map-bms', 'my', 'sco', 'diq', 'se',
            'wuu', 'fur', 'lij', 'ug', 'bh', 'mt', 'nov', 'mzn', 'csb', 'mg',
            'ilo', 'km', 'zh-classical', 'lad', 'pi', 'sc', 'ang', 'frp', 'hif',
            'bo', 'hak', 'ckb', 'kw', 'pa', 'fj', 'xal', 'szl', 'pdc', 'haw',
            'ps', 'cbk-zam', 'ie', 'stq', 'kv', 'crh', 'to', 'ace', 'myv', 'so',
            'gn', 'nv', 'krc', 'ln', 'ky', 'mhr', 'ext', 'arc', 'jbo', 'wo',
            'eml', 'pcd', 'kab', 'ty', 'tpi', 'pap', 'ay', 'zea', 'srn', 'ba',
            'kl', 'ce', 'or', 'ig', 'udm', 'dsb', 'kg', 'lo', 'rmy', 'ab', 'cu',
            'mwl', 'kaa', 'mdf', 'sm', 'av', 'ks', 'tet', 'got', 'sd', 'na',
            'bm', 'pih', 'pnt', 'iu', 'cdo', 'as', 'ik', 'bi', 'ee', 'bug',
            'chr', 'om', 'za', 'ti', 'ss', 'ts', 've', 'ha', 'zu', 'sg', 'dz',
            'ch', 'cr', 'xh', 'ak', 'rw', 'lbe', 'ki', 'tn', 'bxr', 'ny', 'st',
