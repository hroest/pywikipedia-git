...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'cv', 'ga', 'hy', 'yo', 'kn', 'tg', 'ne', 'roa-tara', 'pnb', 'vec',
            'gd', 'yi', 'zh-min-nan', 'tt', 'uz', 'pam', 'os', 'sah', 'als',
            'arz', 'mi', 'kk', 'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'am',
            'mn', 'ia', 'bcl', 'fo', 'fiu-vro', 'sco', 'nds-nl', 'tk', 'vls',
            'si', 'sa', 'my', 'bar', 'gv', 'dv', 'nrm', 'rm', 'pag', 'map-bms',
            'diq', 'ckb', 'se', 'wuu', 'mzn', 'ug', 'fur', 'lij', 'mt', 'bh',
            'nov', 'mg', 'ilo', 'ang', 'csb', 'sc', 'zh-classical', 'km', 'lad',
            'cbk-zam', 'pi', 'bo', 'hif', 'frp', 'hak', 'kw', 'pa', 'ps', 'xal',
            'szl', 'pdc', 'haw', 'nv', 'stq', 'ie', 'kv', 'fj', 'crh', 'to',
            'ace', 'so', 'myv', 'gn', 'mhr', 'krc', 'ext', 'ln', 'ky', 'eml',
            'arc', 'pcd', 'jbo', 'ay', 'wo', 'ba', 'ty', 'kab', 'frr', 'tpi',
            'pap', 'zea', 'srn', 'kl', 'bjn', 'udm', 'ce', 'ig', 'koi', 'or',
            'dsb', 'kg', 'mrj', 'lo', 'ab', 'mdf', 'rmy', 'mwl', 'cu', 'kaa',
            'sm', 'tet', 'av', 'ks', 'got', 'bm', 'sd', 'na', 'pih', 'pnt',
            'iu', 'ik', 'bi', 'chr', 'as', 'cdo', 'ss', 'ee', 'om', 'za', 'zu',
            'ti', 've', 'ts', 'ha', 'dz', 'sg', 'ch', 'cr', 'ak', 'xh', 'st',
            'rw', 'tn', 'ki', 'bxr', 'bug', 'ny', 'lbe', 'tw', 'sn', 'rn', 'ff',
            'chy', 'tum', 'lg',
        ]
