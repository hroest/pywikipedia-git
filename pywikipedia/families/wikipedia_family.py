...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sq', 'lv', 'jv', 'be', 'cy', 'lb', 'mg', 'mr', 'is', 'bs', 'yo',
            'an', 'bpy', 'lmo', 'fy', 'sw', 'bn', 'io', 'ml', 'gu', 'af', 'pnb',
            'hy', 'ne', 'nds', 'scn', 'ur', 'ku', 'zh-yue', 'qu', 'su', 'diq',
            'ast', 'tt', 'ga', 'nap', 'cv', 'bat-smg', 'ia', 'wa', 'map-bms',
            'am', 'kn', 'als', 'bug', 'my', 'zh-min-nan', 'tg', 'vec', 'yi',
            'roa-tara', 'gd', 'os', 'arz', 'nah', 'sah', 'sco', 'uz', 'hif',
            'pam', 'ba', 'sa', 'mn', 'hsb', 'mi', 'li', 'si', 'co', 'gan',
            'glk', 'fo', 'bcl', 'ckb', 'bar', 'bo', 'mrj', 'fiu-vro', 'nds-nl',
            'ilo', 'ky', 'tk', 'vls', 'se', 'gv', 'dv', 'nrm', 'rue', 'pag',
            'pa', 'rm', 'mzn', 'ps', 'km', 'udm', 'fur', 'csb', 'mt', 'wuu',
            'ug', 'lij', 'koi', 'mhr', 'pi', 'kv', 'ang', 'lad', 'bh', 'sc',
            'zea', 'nov', 'zh-classical', 'ksh', 'cbk-zam', 'so', 'hak', 'nv',
            'kw', 'frp', 'stq', 'or', 'szl', 'ext', 'ie', 'pcd', 'xal', 'haw',
            'xmf', 'rw', 'ln', 'pdc', 'frr', 'ay', 'pfl', 'krc', 'to', 'ace',
            'eml', 'crh', 'ce', 'gn', 'myv', 'arc', 'kl', 'pap', 'gag', 'bjn',
            'lbe', 'tpi', 'wo', 'jbo', 'as', 'mdf', 'av', 'kab', 'dsb', 'ty',
            'sn', 'srn', 'lo', 'ab', 'ig', 'na', 'tet', 'kg', 'mwl', 'ltg',
            'nso', 'kaa', 'rmy', 'cu', 'kbd', 'tn', 'sm', 'sd', 'bi', 'bm',
            'ik', 'ss', 'iu', 'pih', 'za', 'chr', 'pnt', 'got', 'cdo', 'ee',
            'ha', 'zu', 'ti', 'ks', 'bxr', 'om', 've', 'ts', 'sg', 'rn', 'cr',
            'dz', 'fj', 'ak', 'tum', 'lg', 'ch', 'chy', 'st', 'ny', 'tw', 'ff',
            'xh', 'ki',
        ]
