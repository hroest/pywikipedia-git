...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'eu', 'hi', 'el', 'ht', 'te', 'roa-rup', 'ka', 'mk', 'ceb', 'la',
            'az', 'br', 'sh', 'mr', 'jv', 'lb', 'bs', 'is', 'lv', 'tl', 'cy',
            'pms', 'sq', 'be-x-old', 'bpy', 'ta', 'oc', 'bn', 'an', 'be', 'io',
            'sw', 'fy', 'nds', 'scn', 'af', 'gu', 'lmo', 'qu', 'su', 'zh-yue',
            'ur', 'ast', 'nap', 'ku', 'ml', 'bat-smg', 'wa', 'cv', 'ksh', 'ga',
            'hy', 'tg', 'yo', 'roa-tara', 'kn', 'vec', 'gd', 'yi', 'uz', 'pam',
            'os', 'zh-min-nan', 'sah', 'tt', 'mi', 'als', 'kk', 'arz', 'nah',
            'li', 'hsb', 'glk', 'co', 'gan', 'ia', 'ne', 'bcl', 'pnb', 'mn',
            'fiu-vro', 'nds-nl', 'vls', 'fo', 'am', 'tk', 'sa', 'si', 'bar',
            'dv', 'nrm', 'pag', 'gv', 'rm', 'map-bms', 'my', 'sco', 'diq', 'se',
            'wuu', 'fur', 'lij', 'ug', 'bh', 'mt', 'nov', 'mzn', 'csb', 'mg',
            'ilo', 'km', 'zh-classical', 'pi', 'lad', 'sc', 'ang', 'frp', 'bo',
            'hif', 'kw', 'ckb', 'hak', 'xal', 'pdc', 'szl', 'haw', 'ps', 'pa',
            'ie', 'fj', 'kv', 'crh', 'to', 'stq', 'myv', 'ace', 'cbk-zam', 'gn',
            'nv', 'krc', 'ln', 'ky', 'mhr', 'so', 'ext', 'arc', 'jbo', 'wo',
            'eml', 'kab', 'ty', 'tpi', 'pap', 'zea', 'ay', 'srn', 'ba', 'or',
            'ig', 'kl', 'dsb', 'ce', 'udm', 'kg', 'pcd', 'lo', 'rmy', 'cu',
            'ab', 'mwl', 'kaa', 'sm', 'mdf', 'av', 'ks', 'tet', 'got', 'sd',
            'na', 'bm', 'pih', 'pnt', 'iu', 'cdo', 'as', 'ee', 'bi', 'chr',
            'bug', 'om', 'za', 'ti', 'ss', 'ts', 've', 'ha', 'zu', 'sg', 'dz',
            'ch', 'cr', 'xh', 'ak', 'ik', 'lbe', 'ki', 'tn', 'bxr', 'rw', 'st',
            'ny', 'tw', 'sn', 'chy', 'ff', 'lg', 'rn', 'tum',
        ]
