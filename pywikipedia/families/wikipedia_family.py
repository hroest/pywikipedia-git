...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'ca', 'no', 'uk', 'fi', 'cs', 'hu', 'vi', 'ko', 'ro', 'tr',
            'id', 'da', 'ar', 'eo', 'sr', 'lt', 'sk', 'vo', 'fa', 'he', 'bg',
            'ms', 'sl', 'war', 'hr', 'et', 'new', 'hi', 'gl', 'simple', 'th',
            'eu', 'nn', 'roa-rup', 'el', 'az', 'ht', 'la', 'tl', 'te', 'ka',
            'mk', 'ceb', 'sh', 'br', 'pms', 'lv', 'mr', 'be-x-old', 'jv', 'lb',
            'sq', 'cy', 'is', 'bs', 'ta', 'be', 'bpy', 'an', 'oc', 'bn', 'io',
            'sw', 'lmo', 'fy', 'gu', 'af', 'nds', 'ml', 'scn', 'ur', 'qu', 'ku',
            'zh-yue', 'su', 'ast', 'nap', 'hy', 'bat-smg', 'yo', 'ga', 'cv',
            'wa', 'ne', 'pnb', 'kn', 'ksh', 'tg', 'roa-tara', 'vec', 'tt', 'yi',
            'gd', 'als', 'zh-min-nan', 'kk', 'os', 'uz', 'pam', 'sah', 'arz',
            'am', 'mi', 'li', 'nah', 'hsb', 'sco', 'gan', 'co', 'glk', 'mn',
            'ia', 'bug', 'my', 'bcl', 'fo', 'fiu-vro', 'nds-nl', 'si', 'vls',
            'tk', 'sa', 'bar', 'mg', 'gv', 'ilo', 'dv', 'nrm', 'pag', 'map-bms',
            'ckb', 'rm', 'diq', 'se', 'mzn', 'wuu', 'fur', 'ug', 'lij', 'mt',
            'bo', 'bh', 'ang', 'nov', 'csb', 'hif', 'sc', 'zh-classical', 'lad',
            'km', 'cbk-zam', 'pi', 'frp', 'ps', 'hak', 'kw', 'rue', 'pa', 'nv',
            'szl', 'xal', 'pdc', 'haw', 'stq', 'ie', 'udm', 'so', 'to', 'kv',
            'krc', 'rw', 'mhr', 'crh', 'ace', 'pcd', 'ln', 'myv', 'mrj', 'ext',
            'gn', 'ky', 'ce', 'eml', 'ba', 'arc', 'pap', 'ay', 'jbo', 'wo',
            'bjn', 'frr', 'kl', 'tpi', 'kab', 'ty', 'srn', 'zea', 'gag', 'ab',
            'dsb', 'koi', 'ig', 'or', 'lo', 'av', 'kg', 'mdf', 'tet', 'mwl',
            'rmy', 'cu', 'lbe', 'kaa', 'sm', 'got', 'ks', 'bm', 'ik', 'sd',
            'bi', 'as', 'na', 'pfl', 'pih', 'pnt', 'iu', 'ss', 'chr', 'cdo',
            'ha', 'ee', 'ti', 'om', 'zu', 'za', 've', 'ts', 'sg', 'rn', 'dz',
            'cr', 'ch', 'lg', 'fj', 'tum', 'bxr', 'ny', 'st', 'ak', 'xh', 'ff',
            'tn', 'sn', 'ki', 'tw', 'chy',
        ]
