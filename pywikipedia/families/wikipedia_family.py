...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'roa-rup', 'eu', 'hi', 'el', 'ht', 'la', 'te', 'tl', 'az', 'ka',
            ...
            'sco', 'bcl', 'fo', 'fiu-vro', 'si', 'nds-nl', 'my', 'tk', 'vls',
            'sa', 'mg', 'bar', 'gv', 'dv', 'ilo', 'nrm', 'rm', 'pag', 'map-bms',
            'diq', 'ckb', 'se', 'mzn', 'wuu', 'fur', 'ug', 'lij', 'mt', 'bh',
            'nov', 'ang', 'csb', 'sc', 'zh-classical', 'bo', 'km', 'lad',
            'cbk-zam', 'pi', 'hif', 'frp', 'hak', 'ps', 'kw', 'pa', 'szl',
            'xal', 'nv', 'pdc', 'haw', 'stq', 'ie', 'fj', 'kv', 'crh', 'so',
            'to', 'ace', 'myv', 'krc', 'mhr', 'ln', 'ext', 'gn', 'pcd', 'ky',
            'eml', 'arc', 'ay', 'jbo', 'wo', 'bjn', 'ba', 'frr', 'kl', 'pfl',
            'pap', 'kab', 'tpi', 'ty', 'srn', 'zea', 'udm', 'mrj', 'ce', 'koi',
            'ig', 'ab', 'dsb', 'or', 'kg', 'lo', 'mdf', 'rmy', 'mwl', 'cu',
            'kaa', 'sm', 'av', 'tet', 'ks', 'got', 'bm', 'sd', 'bi', 'ik', 'na',
            'pih', 'iu', 'pnt', 'as', 'chr', 'ss', 'cdo', 'ha', 'ee', 'lbe',
            'ti', 'zu', 'om', 'za', 've', 'ts', 'dz', 'sg', 'cr', 'ch', 'lg',
            'bxr', 'rw', 'ak', 'xh', 'ny', 'st', 'bug', 'tn', 'ki', 'ff', 'rn',
            'sn', 'tum', 'tw', 'chy', 'gag',
        ]
