...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ar', 'eo', 'id', 'vi', 'sr', 'vo', 'sk', 'lt', 'he', 'bg', 'fa',
            ...
            'sw', 'io', 'ksh', 'fy', 'gu', 'lmo', 'nds', 'af', 'scn', 'qu',
            'ku', 'ur', 'su', 'zh-yue', 'ml', 'ast', 'nap', 'bat-smg', 'wa',
            'ga', 'cv', 'hy', 'yo', 'kn', 'tg', 'roa-tara', 'vec', 'gd', 'pnb',
            'yi', 'zh-min-nan', 'uz', 'pam', 'tt', 'os', 'sah', 'ne', 'als',
            'mi', 'kk', 'arz', 'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'ia',
            'am', 'mn', 'bcl', 'fiu-vro', 'nds-nl', 'fo', 'tk', 'vls', 'si',
            'sa', 'bar', 'gv', 'dv', 'sco', 'nrm', 'pag', 'rm', 'my', 'map-bms',
            'diq', 'ckb', 'se', 'wuu', 'mzn', 'fur', 'ug', 'lij', 'mt', 'bh',
            'nov', 'mg', 'csb', 'sc', 'ilo', 'zh-classical', 'km', 'lad', 'pi',
            'ang', 'cbk-zam', 'frp', 'bo', 'hif', 'hak', 'pa', 'kw', 'ps',
            'xal', 'pdc', 'szl', 'haw', 'ie', 'stq', 'crh', 'fj', 'kv', 'to',
            'ace', 'so', 'nv', 'myv', 'gn', 'krc', 'ky', 'ln', 'ext', 'mhr',
            'arc', 'jbo', 'eml', 'wo', 'ay', 'pcd', 'kab', 'ty', 'tpi', 'frr',
            'pap', 'ba', 'zea', 'srn', 'kl', 'udm', 'ce', 'ig', 'or', 'dsb',
            'kg', 'lo', 'ab', 'rmy', 'cu', 'mwl', 'mdf', 'kaa', 'sm', 'av',
            'tet', 'ks', 'got', 'sd', 'na', 'bm', 'pih', 'pnt', 'sn', 'iu',
            'ik', 'chr', 'as', 'cdo', 'bi', 'ee', 'bug', 'ss', 'om', 'za', 'ti',
            'ts', 've', 'zu', 'ha', 'dz', 'sg', 'ch', 'cr', 'ak', 'xh', 'rw',
            'tn', 'ki', 'bxr', 'ny', 'lbe', 'st', 'tw', 'rn', 'chy', 'ff',
            'tum', 'lg',
        ]
