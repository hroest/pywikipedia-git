...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'tg', 'zh-min-nan', 'bug', 'vec', 'ia', 'roa-tara', 'yi', 'gd',
            'arz', 'os', 'sah', 'uz', 'pam', 'my', 'sco', 'hsb', 'mi', 'nah',
            'li', 'mn', 'co', 'gan', 'glk', 'sa', 'ba', 'si', 'hif', 'bcl',
            'fo', 'mrj', 'fiu-vro', 'bar', 'ckb', 'nds-nl', 'vls', 'tk', 'gv',
            'ilo', 'se', 'map-bms', 'dv', 'nrm', 'pag', 'rm', 'pa', 'mzn', 'bo',
            'udm', 'ps', 'fur', 'km', 'wuu', 'mt', 'csb', 'ug', 'lij', 'koi',
            'pi', 'ang', 'kv', 'bh', 'rue', 'sc', 'lad', 'nov', 'zh-classical',
            'mhr', 'ksh', 'cbk-zam', 'hak', 'so', 'kw', 'nv', 'frp', 'szl',
            'ext', 'stq', 'ie', 'xal', 'rw', 'haw', 'ln', 'pdc', 'ky', 'pcd',
            'pfl', 'krc', 'to', 'or', 'crh', 'ace', 'eml', 'myv', 'frr', 'gn',
            'ay', 'arc', 'kl', 'ce', 'pap', 'bjn', 'lbe', 'jbo', 'wo', 'tpi',
            'mdf', 'av', 'zea', 'kab', 'gag', 'ty', 'srn', 'dsb', 'xmf', 'lo',
            'ab', 'ig', 'as', 'na', 'tet', 'kg', 'mwl', 'ltg', 'kaa', 'rmy',
            'cu', 'kbd', 'sm', 'sd', 'bm', 'bi', 'ik', 'ss', 'iu', 'pih', 'ks',
            'pnt', 'za', 'chr', 'cdo', 'ee', 'got', 'ha', 'ti', 'sn', 'bxr',
            'om', 'zu', 've', 'ts', 'rn', 'sg', 'cr', 'dz', 'tum', 'lg', 'ch',
            'fj', 'ny', 'tn', 'ff', 'st', 'xh', 'ak', 'chy', 'ki', 'tw',
        ]
