...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            'en', 'de', 'fr', 'it', 'pl', 'es', 'ru', 'ja', 'nl', 'pt', 'sv',
            'zh', 'ca', 'uk', 'no', 'fi', 'vi', 'cs', 'hu', 'ko', 'tr', 'id',
            'ro', 'fa', 'ar', 'da', 'eo', 'sr', 'lt', 'sk', 'he', 'ms', 'bg',
            'sl', 'vo', 'eu', 'war', 'hr', 'hi', 'et', 'kk', 'az', 'gl',
            'simple', 'nn', 'new', 'th', 'el', 'roa-rup', 'la', 'tl', 'ht',
            'ka', 'mk', 'sh', 'te', 'pms', 'ceb', 'be-x-old', 'br', 'ta', 'jv',
            'lv', 'mr', 'sq', 'be', 'cy', 'lb', 'is', 'bs', 'oc', 'yo', 'an',
            'mg', 'bpy', 'bn', 'io', 'fy', 'lmo', 'sw', 'gu', 'ml', 'pnb', 'af',
            'nds', 'scn', 'ur', 'ku', 'zh-yue', 'qu', 'ne', 'hy', 'diq', 'ast',
            'su', 'nap', 'ga', 'cv', 'bat-smg', 'tt', 'wa', 'am', 'kn', 'als',
            'ia', 'tg', 'zh-min-nan', 'bug', 'vec', 'roa-tara', 'yi', 'gd',
            'arz', 'os', 'sah', 'uz', 'pam', 'my', 'sco', 'nah', 'hsb', 'mi',
            'li', 'mn', 'sa', 'co', 'gan', 'glk', 'ba', 'si', 'hif', 'bcl',
            'fo', 'mrj', 'ckb', 'bar', 'fiu-vro', 'nds-nl', 'tk', 'vls', 'gv',
            'ilo', 'se', 'map-bms', 'dv', 'nrm', 'pag', 'pa', 'rm', 'mzn', 'bo',
            'ps', 'udm', 'km', 'fur', 'csb', 'wuu', 'mt', 'ug', 'lij', 'koi',
            'pi', 'rue', 'ang', 'kv', 'bh', 'sc', 'lad', 'mhr', 'nov',
            'zh-classical', 'ksh', 'cbk-zam', 'ky', 'hak', 'so', 'kw', 'nv',
            'frp', 'szl', 'ext', 'stq', 'ie', 'xal', 'rw', 'haw', 'ln', 'pdc',
            'pcd', 'pfl', 'or', 'krc', 'to', 'crh', 'ace', 'eml', 'frr', 'myv',
            'gn', 'ay', 'arc', 'kl', 'ce', 'pap', 'bjn', 'lbe', 'gag', 'tpi',
            'jbo', 'wo', 'mdf', 'zea', 'av', 'kab', 'ty', 'srn', 'dsb', 'lo',
            'xmf', 'ab', 'as', 'ig', 'na', 'tet', 'kg', 'mwl', 'kaa', 'rmy',
            'ltg', 'cu', 'kbd', 'sm', 'sn', 'sd', 'bi', 'bm', 'ik', 'iu', 'ss',
            'pih', 'ks', 'pnt', 'za', 'chr', 'cdo', 'got', 'ee', 'ha', 'ti',
            'bxr', 'zu', 'om', 've', 'ts', 'rn', 'sg', 'cr', 'dz', 'tum', 'fj',
            'lg', 'ch', 'ny', 'ff', 'st', 'tn', 'ak', 'xh', 'chy', 'ki', 'tw',
        ]
        ...
        self.namespaces[4] = {
            ...
            'mhr': u'Википедий',
            'mk': u'Википедија',
            'ml': [u'വിക്കിപീഡിയ', u'വിക്കി', u'WP'],
            'mr': [u'विकिपीडिया', u'विपी'],
            'mrj': u'Википеди',
            'mt': u'Wikipedija',
            'mwl': u'Biquipédia',
            'myv': u'Википедиясь',
            ...
            'sv': [u'Wikipedia', u'WP'],
            'szl': u'Wikipedyjo',
            'ta': [u'விக்கிப்பீடியா', u'விக்கிபீடியா'],
            'te': u'వికీపీడియా',
            'tg': u'Википедиа',
            'th': u'วิกิพีเดีย',
            'tk': u'Wikipediýa',
            'tr': u'Vikipedi',
            'tt': [u'Википедия', u'WP', u'ВП'],
            'uk': [u'Вікіпедія', u'ВП'],
            'ur': u'منصوبہ',
            'uz': u'Vikipediya',
            ...
            'zh-classical': [u'維基大典', u'Wikipedia talk'],
        ...
        self.namespaces[5] = {
            ...
            'cu': [u'Википє́дїѩ бєсѣ́да', u'Википє́дїꙗ бесѣда'],
            ...
            'ta': [u'விக்கிப்பீடியா பேச்சு', u'விக்கிபீடியா பேச்சு'],
            ...
            'tt': [u'Википедия бәхәсе', u'Обсуждение Википедии', u'Википедия bäxäse'],
