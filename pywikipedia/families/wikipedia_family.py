...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ace', 'mhr', 'pcd', 'rw', 'myv', 'ln', 'ext', 'gn', 'ky', 'eml',
            'arc', 'pap', 'ay', 'ce', 'jbo', 'wo', 'bjn', 'ba', 'frr', 'kl',
            'tpi', 'udm', 'kab', 'ty', 'srn', 'zea', 'mrj', 'koi', 'dsb', 'ab',
            'gag', 'ig', 'or', 'lo', 'kg', 'av', 'mdf', 'mwl', 'rmy', 'cu',
            'kaa', 'sm', 'tet', 'got', 'ks', 'bm', 'ik', 'sd', 'bi', 'lbe',
            'na', 'pih', 'iu', 'pnt', 'as', 'chr', 'cdo', 'ss', 'pfl', 'ha',
            'ee', 'ti', 'om', 'zu', 'za', 've', 'ts', 'rn', 'cr', 'dz', 'sg',
            'ch', 'lg', 'bug', 'bxr', 'fj', 'ny', 'ak', 'st', 'xh', 'ff', 'tn',
            'ki', 'tum', 'sn', 'tw', 'chy',
        ]
