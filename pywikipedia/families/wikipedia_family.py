...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'nn', 'new', 'th', 'el', 'roa-rup', 'la', 'ht', 'tl', 'ka', 'kk',
            'te', 'mk', 'sh', 'nap', 'ceb', 'pms', 'br', 'be-x-old', 'lv', 'jv',
            'mr', 'ta', 'sq', 'lb', 'cy', 'is', 'bs', 'be', 'oc', 'yo', 'an',
            'bpy', 'bn', 'io', 'sw', 'lmo', 'fy', 'gu', 'mg', 'ml', 'af', 'nds',
            'ur', 'scn', 'pnb', 'qu', 'ku', 'zh-yue', 'ne', 'ast', 'su', 'hy',
            'ga', 'bat-smg', 'cv', 'wa', 'am', 'kn', 'tt', 'diq', 'als', 'tg',
            'vec', 'roa-tara', 'zh-min-nan', 'yi', 'bug', 'gd', 'os', 'uz',
            'sah', 'pam', 'arz', 'mi', 'hsb', 'sco', 'li', 'nah', 'mn', 'my',
            'co', 'gan', 'glk', 'ia', 'hif', 'bcl', 'fo', 'sa', 'si', 'fiu-vro',
            'nds-nl', 'bar', 'mrj', 'vls', 'tk', 'ckb', 'gv', 'ilo', 'se',
            'map-bms', 'dv', 'nrm', 'pag', 'rm', 'mzn', 'bo', 'udm', 'fur',
            'wuu', 'ug', 'ps', 'mt', 'csb', 'lij', 'km', 'pi', 'bh', 'ang',
            'koi', 'kv', 'lad', 'sc', 'nov', 'zh-classical', 'mhr', 'cbk-zam',
            'ksh', 'kw', 'rue', 'frp', 'so', 'hak', 'nv', 'pa', 'szl', 'xal',
            'ie', 'rw', 'stq', 'haw', 'pdc', 'ln', 'ext', 'krc', 'to', 'pcd',
            'ky', 'crh', 'ace', 'myv', 'eml', 'gn', 'ba', 'ce', 'arc', 'kl',
            'or', 'ay', 'pap', 'frr', 'bjn', 'pfl', 'jbo', 'wo', 'tpi', 'kab',
            'ty', 'srn', 'gag', 'zea', 'dsb', 'lo', 'ab', 'ig', 'mdf', 'tet',
            'av', 'kg', 'mwl', 'lbe', 'rmy', 'na', 'kaa', 'ltg', 'cu', 'kbd',
            'as', 'sm', 'bm', 'ik', 'bi', 'sd', 'ss', 'ks', 'iu', 'pih', 'pnt',
            'cdo', 'chr', 'got', 'ee', 'ha', 'za', 'ti', 'bxr', 'om', 'zu',
            've', 'ts', 'rn', 'sg', 'dz', 'tum', 'cr', 'ch', 'lg', 'fj', 'ny',
            'st', 'xh', 'ff', 'tn', 'ki', 'sn', 'chy', 'ak', 'tw', 'xmf'
        ]
