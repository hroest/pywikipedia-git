...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh', 'ca', 'uk', 'no', 'vi', 'fi', 'cs', 'hu', 'ko', 'id', 'tr',
            'ro', 'fa', 'ar', 'da', 'eo', 'sr', 'lt', 'sl', 'sk', 'ms', 'he',
            'bg', 'kk', 'eu', 'vo', 'war', 'hr', 'hi', 'et', 'az', 'gl',
            'simple', 'nn', 'th', 'new', 'la', 'el', 'roa-rup', 'oc', 'tl',
            'ka', 'mk', 'sh', 'ht', 'pms', 'te', 'ta', 'ceb', 'be-x-old', 'br',
            'sq', 'lv', 'be', 'jv', 'mg', 'cy', 'lb', 'mr', 'is', 'bs', 'yo',
            'an', 'bpy', 'lmo', 'fy', 'bn', 'sw', 'io', 'ml', 'gu', 'hy', 'af',
            'pnb', 'ne', 'nds', 'scn', 'ur', 'ku', 'zh-yue', 'su', 'qu', 'diq',
            'ba', 'ast', 'tt', 'ga', 'nap', 'ia', 'cv', 'bat-smg', 'map-bms',
            'wa', 'am', 'kn', 'als', 'bug', 'my', 'zh-min-nan', 'tg', 'vec',
            'yi', 'roa-tara', 'gd', 'hif', 'os', 'arz', 'sco', 'nah', 'sah',
            'uz', 'pam', 'sa', 'mn', 'hsb', 'mi', 'li', 'si', 'co', 'gan',
            'glk', 'bcl', 'fo', 'ckb', 'bar', 'bo', 'mrj', 'ky', 'ilo',
            'fiu-vro', 'nds-nl', 'tk', 'vls', 'se', 'gv', 'dv', 'nrm', 'rue',
            'pag', 'pa', 'rm', 'mzn', 'ps', 'km', 'udm', 'fur', 'csb', 'mt',
            'wuu', 'ug', 'lij', 'koi', 'kv', 'mhr', 'pi', 'ang', 'lad', 'bh',
            'sc', 'zea', 'zh-classical', 'nov', 'ksh', 'cbk-zam', 'so', 'nv',
            'hak', 'or', 'kw', 'frp', 'stq', 'szl', 'ext', 'pcd', 'ie', 'xmf',
            'xal', 'haw', 'frr', 'rw', 'ln', 'pdc', 'ay', 'pfl', 'krc', 'to',
            'ace', 'eml', 'crh', 'ce', 'gn', 'myv', 'kl', 'arc', 'pap', 'gag',
            'bjn', 'lbe', 'tpi', 'wo', 'as', 'jbo', 'mdf', 'av', 'dsb', 'kab',
            'ty', 'sn', 'srn', 'lo', 'ab', 'ig', 'na', 'kg', 'tet', 'mwl',
            'ltg', 'kaa', 'nso', 'rmy', 'vep', 'cu', 'tn', 'kbd', 'sm', 'sd',
            'bi', 'bm', 'ik', 'iu', 'ss', 'pih', 'za', 'chr', 'pnt', 'got',
            'cdo', 'ee', 'ha', 'zu', 'ti', 'ks', 'om', 'bxr', 've', 'ts', 'sg',
            'rn', 'cr', 'dz', 'ny', 'fj', 'ak', 'tum', 'lg', 'chy', 'st', 'ch',
            'tw', 'ff', 'xh', 'ki',
        ]
        ...
        self.namespaces[4] = {
            ...
            'arz': u'ويكيبيديا',
            'as': [u'ৱিকিপিডিয়া', u'Wikipedia', u'প্ৰকল্প'],
            'ast': u'Uiquipedia',
            'av': u'Wikipedia',
            'ay': u'Wikipidiya',
            'az': u'Vikipediya',
        ...
        self.alphabetic_latin = [
            ...
            'ur', 'ug', 'za', 'vec', 'vep', 'vo', 'fiu-vro', 'wa', 'vls', 'war',
            'wo', 'wuu', 'ts', 'xmf', 'yi', 'yo', 'diq', 'zea', 'zh', 'zh-tw',
