...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sl', 'hr', 'war', 'et', 'new', 'ms', 'simple', 'th', 'gl', 'nn',
            'eu', 'hi', 'el', 'roa-rup', 'ht', 'te', 'ka', 'mk', 'ceb', 'la',
            'az', 'br', 'sh', 'mr', 'jv', 'lb', 'bs', 'tl', 'is', 'lv', 'cy',
            'pms', 'sq', 'be-x-old', 'bpy', 'ta', 'oc', 'an', 'bn', 'be', 'io',
            'sw', 'fy', 'nds', 'scn', 'lmo', 'af', 'gu', 'qu', 'su', 'zh-yue',
            'ur', 'ast', 'ku', 'nap', 'ml', 'bat-smg', 'wa', 'cv', 'ksh', 'ga',
            'hy', 'tg', 'yo', 'kn', 'roa-tara', 'vec', 'gd', 'yi', 'uz', 'pam',
            'zh-min-nan', 'os', 'sah', 'tt', 'mi', 'als', 'arz', 'kk', 'nah',
            'li', 'hsb', 'glk', 'co', 'ne', 'gan', 'ia', 'pnb', 'bcl', 'mn',
            'fiu-vro', 'nds-nl', 'vls', 'fo', 'am', 'tk', 'sa', 'si', 'bar',
            'dv', 'nrm', 'gv', 'pag', 'rm', 'map-bms', 'my', 'sco', 'diq', 'se',
            'wuu', 'fur', 'lij', 'ug', 'bh', 'mt', 'nov', 'mzn', 'csb', 'mg',
            'ilo', 'km', 'zh-classical', 'pi', 'lad', 'sc', 'ang', 'frp', 'bo',
            'hif', 'ckb', 'kw', 'hak', 'xal', 'pdc', 'szl', 'haw', 'ps', 'pa',
            'ie', 'cbk-zam', 'fj', 'kv', 'crh', 'to', 'stq', 'ace', 'myv', 'gn',
            'krc', 'nv', 'ln', 'so', 'ky', 'mhr', 'ext', 'arc', 'jbo', 'wo',
            'eml', 'kab', 'ty', 'tpi', 'pcd', 'pap', 'zea', 'ay', 'srn', 'ba',
            'ce', 'or', 'kl', 'ig', 'udm', 'dsb', 'kg', 'lo', 'rmy', 'ab', 'cu',
            'mwl', 'kaa', 'mdf', 'sm', 'av', 'ks', 'tet', 'got', 'sd', 'na',
            'bm', 'pih', 'pnt', 'iu', 'cdo', 'as', 'bi', 'ee', 'chr', 'bug',
            'om', 'za', 'ti', 'ss', 'ts', 've', 'ha', 'zu', 'sg', 'dz', 'ch',
            'cr', 'xh', 'ak', 'ik', 'rw', 'lbe', 'ki', 'tn', 'bxr', 'st', 'ny',
            'tw', 'sn', 'chy', 'ff', 'lg', 'rn', 'tum',
        ]
