...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'roa-rup', 'nn', 'eu', 'hi', 'el', 'ht', 'la', 'te', 'ka', 'ceb',
            'mk', 'tl', 'az', 'br', 'sh', 'mr', 'lb', 'jv', 'lv', 'bs', 'is',
            'cy', 'be-x-old', 'pms', 'sq', 'ta', 'be', 'bpy', 'an', 'oc', 'bn',
            'sw', 'io', 'ksh', 'fy', 'lmo', 'gu', 'nds', 'af', 'qu', 'scn',
            'ku', 'ur', 'ml', 'su', 'zh-yue', 'ast', 'nap', 'bat-smg', 'wa',
            'ga', 'cv', 'hy', 'yo', 'ne', 'kn', 'tg', 'pnb', 'roa-tara', 'vec',
            'gd', 'yi', 'zh-min-nan', 'tt', 'uz', 'pam', 'os', 'sah', 'als',
            'arz', 'mi', 'kk', 'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'am',
            'mn', 'ia', 'bcl', 'fo', 'sco', 'fiu-vro', 'nds-nl', 'tk', 'vls',
            'si', 'sa', 'my', 'bar', 'gv', 'dv', 'nrm', 'mg', 'rm', 'pag',
            'map-bms', 'diq', 'ckb', 'se', 'wuu', 'mzn', 'ug', 'fur', 'lij',
            'mt', 'bh', 'nov', 'ang', 'ilo', 'csb', 'sc', 'zh-classical', 'km',
            'lad', 'cbk-zam', 'pi', 'bo', 'hif', 'frp', 'hak', 'kw', 'ps', 'pa',
            'szl', 'xal', 'pdc', 'haw', 'nv', 'stq', 'ie', 'kv', 'fj', 'crh',
            'to', 'so', 'ace', 'myv', 'gn', 'mhr', 'krc', 'ext', 'ln', 'ky',
            'eml', 'arc', 'pcd', 'jbo', 'ay', 'wo', 'ba', 'frr', 'kab', 'pap',
            'tpi', 'ty', 'srn', 'zea', 'bjn', 'kl', 'udm', 'koi', 'ce', 'ig',
            'or', 'dsb', 'mrj', 'kg', 'lo', 'ab', 'mdf', 'rmy', 'mwl', 'cu',
            'kaa', 'sm', 'tet', 'av', 'ks', 'got', 'bm', 'sd', 'na', 'pih',
            'pnt', 'iu', 'ik', 'bi', 'chr', 'as', 'cdo', 'ss', 'ee', 'om', 'za',
            'zu', 'ti', 'ts', 've', 'ha', 'dz', 'sg', 'ch', 'cr', 'ak', 'xh',
            'rw', 'st', 'bug', 'tn', 'ki', 'bxr', 'ny', 'lbe', 'tw', 'sn', 'rn',
            'ff', 'chy', 'tum', 'lg',
        ]
