...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'th', 'nn', 'roa-rup', 'el', 'az', 'la', 'ht', 'tl', 'ka', 'te',
            'mk', 'ceb', 'sh', 'pms', 'br', 'be-x-old', 'lv', 'mr', 'jv', 'lb',
            'cy', 'sq', 'ta', 'is', 'bs', 'be', 'oc', 'an', 'bpy', 'nap', 'bn',
            'io', 'kk', 'sw', 'lmo', 'fy', 'gu', 'ml', 'af', 'nds', 'ur', 'scn',
            'qu', 'ku', 'zh-yue', 'su', 'ast', 'hy', 'ne', 'yo', 'bat-smg',
            'ga', 'cv', 'wa', 'pnb', 'mg', 'kn', 'tg', 'vec', 'roa-tara', 'tt',
            'als', 'zh-min-nan', 'yi', 'bug', 'gd', 'os', 'uz', 'sah', 'pam',
            ...
            'bo', 'mt', 'hif', 'bh', 'csb', 'ang', 'nov', 'km', 'lad', 'sc',
            'zh-classical', 'udm', 'cbk-zam', 'pi', 'ps', 'mhr', 'ksh', 'frp',
            'hak', 'rue', 'kw', 'nv', 'pa', 'szl', 'so', 'xal', 'rw', 'ie',
            'haw', 'stq', 'pdc', 'kv', 'ln', 'krc', 'to', 'pcd', 'crh', 'ace',
            'ky', 'ext', 'myv', 'gn', 'ba', 'eml', 'ce', 'arc', 'pap', 'ay',
            'kl', 'bjn', 'frr', 'jbo', 'wo', 'tpi', 'kab', 'ty', 'srn', 'zea',
            'gag', 'koi', 'or', 'dsb', 'ab', 'lo', 'ig', 'av', 'tet', 'mdf',
