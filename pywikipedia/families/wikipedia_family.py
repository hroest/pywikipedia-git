...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sl', 'war', 'hr', 'ms', 'et', 'new', 'simple', 'gl', 'th',
            'roa-rup', 'nn', 'eu', 'hi', 'el', 'ht', 'la', 'te', 'tl', 'ka',
            'ceb', 'mk', 'az', 'br', 'sh', 'mr', 'lb', 'lv', 'jv', 'bs', 'is',
            'cy', 'be-x-old', 'pms', 'sq', 'ta', 'be', 'bpy', 'an', 'oc', 'bn',
            'sw', 'io', 'ksh', 'fy', 'lmo', 'gu', 'nds', 'af', 'qu', 'scn',
            'ku', 'ml', 'ur', 'su', 'zh-yue', 'ast', 'nap', 'bat-smg', 'wa',
            'ga', 'cv', 'hy', 'yo', 'ne', 'kn', 'tg', 'pnb', 'roa-tara', 'vec',
            'gd', 'yi', 'zh-min-nan', 'tt', 'uz', 'pam', 'os', 'sah', 'als',
            'arz', 'mi', 'kk', 'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'am',
            'mn', 'ia', 'bcl', 'sco', 'fo', 'fiu-vro', 'nds-nl', 'tk', 'si',
            'vls', 'sa', 'my', 'mg', 'bar', 'gv', 'dv', 'ilo', 'nrm', 'rm',
            'pag', 'map-bms', 'diq', 'ckb', 'se', 'mzn', 'wuu', 'ug', 'fur',
            'lij', 'mt', 'bh', 'nov', 'ang', 'csb', 'sc', 'zh-classical', 'km',
            'lad', 'cbk-zam', 'pi', 'bo', 'hif', 'frp', 'hak', 'kw', 'ps', 'pa',
            'szl', 'xal', 'pdc', 'haw', 'nv', 'stq', 'ie', 'kv', 'fj', 'crh',
            'so', 'to', 'ace', 'myv', 'mhr', 'gn', 'krc', 'ext', 'ln', 'ky',
            'eml', 'pcd', 'arc', 'jbo', 'ay', 'wo', 'bjn', 'ba', 'frr', 'kab',
            'pap', 'tpi', 'ty', 'srn', 'zea', 'kl', 'udm', 'koi', 'ce', 'ig',
            'dsb', 'or', 'mrj', 'kg', 'lo', 'ab', 'mdf', 'rmy', 'mwl', 'cu',
            'kaa', 'sm', 'tet', 'av', 'ks', 'got', 'bm', 'sd', 'na', 'ik',
            'pih', 'pnt', 'iu', 'chr', 'bi', 'as', 'cdo', 'ss', 'ee', 'om',
            'za', 'zu', 'ti', 'ts', 've', 'ha', 'dz', 'sg', 'ch', 'cr', 'ak',
            'xh', 'rw', 'st', 'bug', 'tn', 'ki', 'bxr', 'ny', 'lbe', 'tw', 'sn',
            'rn', 'ff', 'chy', 'tum', 'lg',
        ]
