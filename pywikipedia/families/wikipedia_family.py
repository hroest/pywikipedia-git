...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'mk', 'ceb', 'sh', 'nap', 'pms', 'br', 'be-x-old', 'lv', 'mr', 'jv',
            'lb', 'ta', 'sq', 'cy', 'is', 'bs', 'be', 'oc', 'an', 'bpy', 'bn',
            'kk', 'io', 'sw', 'lmo', 'fy', 'gu', 'ml', 'af', 'mg', 'nds', 'scn',
            'ur', 'qu', 'ku', 'zh-yue', 'su', 'ast', 'ne', 'hy', 'pnb', 'yo',
            'bat-smg', 'cv', 'ga', 'wa', 'kn', 'am', 'als', 'tg', 'vec',
            'roa-tara', 'zh-min-nan', 'tt', 'yi', 'bug', 'gd', 'os', 'uz',
            'sah', 'pam', 'arz', 'mi', 'li', 'hsb', 'sco', 'nah', 'mn', 'co',
            'gan', 'my', 'glk', 'ia', 'bcl', 'fo', 'sa', 'si', 'fiu-vro',
            'nds-nl', 'vls', 'tk', 'bar', 'mrj', 'ckb', 'gv', 'ilo', 'se',
            'map-bms', 'dv', 'nrm', 'pag', 'diq', 'hif', 'rm', 'mzn', 'bo',
            'wuu', 'fur', 'ug', 'mt', 'lij', 'csb', 'km', 'bh', 'ang', 'lad',
            'nov', 'udm', 'sc', 'zh-classical', 'cbk-zam', 'mhr', 'ps', 'pi',
            'kv', 'ksh', 'frp', 'rue', 'hak', 'kw', 'nv', 'so', 'pa', 'koi',
            'szl', 'xal', 'ie', 'rw', 'stq', 'haw', 'pdc', 'ln', 'krc', 'to',
            'ext', 'pcd', 'crh', 'ky', 'ace', 'myv', 'gn', 'ba', 'eml', 'ce',
            'arc', 'pap', 'ay', 'kl', 'bjn', 'frr', 'jbo', 'pfl', 'wo', 'or',
            'tpi', 'kab', 'ty', 'srn', 'gag', 'zea', 'dsb', 'ab', 'lo', 'ig',
            'mdf', 'tet', 'av', 'kg', 'mwl', 'rmy', 'ltg', 'cu', 'lbe', 'kaa',
            'kbd', 'sm', 'na', 'got', 'bm', 'as', 'ik', 'sd', 'bi', 'ks', 'iu',
            'pih', 'ss', 'pnt', 'chr', 'cdo', 'ee', 'ha', 'ti', 'bxr', 'za',
            'om', 'zu', 've', 'ts', 'rn', 'sg', 'dz', 'tum', 'cr', 'ch', 'lg',
            'fj', 'ny', 'st', 'xh', 'ff', 'tn', 'ki', 'sn', 'chy', 'ak', 'tw',
        ]
