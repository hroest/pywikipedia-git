...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'eo', 'ar', 'id', 'vi', 'vo', 'sr', 'sk', 'lt', 'he', 'bg', 'sl',
            'fa', 'war', 'hr', 'et', 'new', 'ms', 'simple', 'th', 'gl',
            'roa-rup', 'nn', 'eu', 'hi', 'el', 'ht', 'te', 'la', 'ka', 'mk',
            'ceb', 'az', 'br', 'sh', 'tl', 'mr', 'jv', 'lb', 'bs', 'lv', 'is',
            'cy', 'pms', 'sq', 'be-x-old', 'bpy', 'ta', 'be', 'an', 'oc', 'bn',
            'io', 'sw', 'fy', 'nds', 'gu', 'lmo', 'scn', 'af', 'qu', 'ku', 'su',
            'zh-yue', 'ur', 'ml', 'ast', 'nap', 'bat-smg', 'wa', 'cv', 'ga',
            'ksh', 'hy', 'yo', 'tg', 'kn', 'roa-tara', 'vec', 'gd', 'yi', 'uz',
            'zh-min-nan', 'pam', 'os', 'tt', 'sah', 'ne', 'als', 'mi', 'arz',
            'kk', 'nah', 'li', 'hsb', 'glk', 'co', 'gan', 'pnb', 'ia', 'bcl',
            'mn', 'am', 'fiu-vro', 'nds-nl', 'fo', 'vls', 'tk', 'sa', 'si',
            'bar', 'dv', 'gv', 'nrm', 'pag', 'rm', 'map-bms', 'my', 'sco',
            'diq', 'se', 'ckb', 'wuu', 'fur', 'mzn', 'lij', 'ug', 'mt', 'bh',
            'nov', 'csb', 'mg', 'sc', 'ilo', 'km', 'zh-classical', 'lad', 'pi',
            'ang', 'cbk-zam', 'frp', 'bo', 'hak', 'hif', 'pa', 'kw', 'xal',
            'szl', 'haw', 'pdc', 'ps', 'ie', 'stq', 'fj', 'crh', 'kv', 'to',
            'ace', 'myv', 'nv', 'so', 'gn', 'ky', 'krc', 'ln', 'ext', 'mhr',
            'arc', 'jbo', 'wo', 'ee', 'eml', 'ty', 'pcd', 'kab', 'tpi', 'pap',
            'ay', 'zea', 'ba', 'srn', 'kl', 'udm', 'ig', 'ce', 'or', 'dsb',
            'kg', 'lo', 'ab', 'rmy', 'cu', 'mwl', 'mdf', 'kaa', 'frr', 'sm',
            'av', 'ks', 'tet', 'got', 'sd', 'na', 'bm', 'pih', 'pnt', 'iu',
            'ik', 'as', 'cdo', 'bi', 'chr', 'bug', 'om', 'za', 'ss', 'ti', 'ts',
            've', 'zu', 'ha', 'dz', 'sg', 'ch', 'cr', 'xh', 'lbe', 'ak', 'rw',
            'ki', 'tn', 'bxr', 'ny', 'st', 'tw', 'sn', 'rn', 'chy', 'ff', 'tum',
            'lg',
        ]
