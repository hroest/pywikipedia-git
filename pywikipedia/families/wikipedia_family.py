...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'lb', 'cy', 'ta', 'sq', 'is', 'bs', 'be', 'oc', 'an', 'bpy', 'bn',
            'io', 'sw', 'kk', 'lmo', 'fy', 'gu', 'ml', 'af', 'nds', 'ur', 'scn',
            'qu', 'ku', 'zh-yue', 'su', 'ast', 'mg', 'hy', 'ne', 'yo',
            'bat-smg', 'ga', 'cv', 'pnb', 'wa', 'kn', 'als', 'am', 'tg', 'vec',
            'roa-tara', 'tt', 'zh-min-nan', 'yi', 'bug', 'gd', 'os', 'uz',
            'sah', 'pam', 'arz', 'mi', 'li', 'hsb', 'nah', 'sco', 'mn', 'co',
            'gan', 'glk', 'my', 'ia', 'bcl', 'fo', 'sa', 'fiu-vro', 'si',
            'nds-nl', 'vls', 'tk', 'bar', 'ckb', 'gv', 'ilo', 'mrj', 'map-bms',
            'dv', 'nrm', 'pag', 'rm', 'diq', 'se', 'mzn', 'wuu', 'fur', 'ug',
            'bo', 'lij', 'mt', 'hif', 'csb', 'bh', 'km', 'ang', 'lad', 'nov',
            'udm', 'sc', 'zh-classical', 'cbk-zam', 'pi', 'ps', 'mhr', 'kv',
            'ksh', 'frp', 'hak', 'rue', 'kw', 'nv', 'pa', 'szl', 'so', 'xal',
            'ie', 'rw', 'stq', 'haw', 'pdc', 'koi', 'ln', 'krc', 'to', 'pcd',
            'crh', 'ky', 'ace', 'ext', 'myv', 'gn', 'ba', 'eml', 'ce', 'arc',
            'pap', 'ay', 'kl', 'bjn', 'frr', 'jbo', 'wo', 'tpi', 'kab', 'or',
            'ty', 'srn', 'zea', 'gag', 'dsb', 'ab', 'lo', 'ig', 'mdf', 'tet',
            'av', 'kg', 'mwl', 'rmy', 'cu', 'lbe', 'ltg', 'kaa', 'kbd', 'sm',
            'na', 'got', 'pfl', 'bm', 'ik', 'as', 'sd', 'bi', 'ks', 'iu', 'pih',
            'ss', 'pnt', 'chr', 'cdo', 'ee', 'ha', 'ti', 'bxr', 'zu', 'om',
            'za', 've', 'ts', 'rn', 'sg', 'dz', 'tum', 'cr', 'ch', 'lg', 'fj',
