...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'da', 'th', 'gl', 'fa', 'ko', 'ta', 'no', 'sr', 'ar', 'tl', 'mk',
        ...
        self.namespaces[4] = {
            ...
            'la': u'Vicilibri',
            'li': u'Wikibeuk',
            'ml': [u'വിക്കിപാഠശാല', u'വിക്കി‌‌ പുസ്തകശാല'],
            'no': u'Wikibøker',
            'oc': u'Wikilibres',
            'pl': [u'Wikibooks', u'WB'],
            'ps': u'ويکيتابونه',
        ...
        self.namespaces[5] = {
            ...
            'cs': [u'Diskuse k Wikiknihám', u'Wikibooks diskuse', u'Wikiknihy diskuse'],
            ...
            'ml': [u'വിക്കിപാഠശാല സംവാദം', u'വിക്കി‌‌ പുസ്തകശാല സംവാദം'],
            ...
            'ta': [u'Wikibooks பேச்சு', u'விக்கிபீடியா பேச்சு'],
            'te': u'Wikibooks చర్చ',
