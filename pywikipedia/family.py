    ...
    def __init__(self):
        ...
        self.namespaces = {
            ...
            2: {
                ...
                'cs': [u'Wikipedista', u'Uživatel', u'Wikipedistka', u'Uživatelka'],
                'csb': [u'Brëkòwnik', u'Użytkownik', u'Użytkowniczka'],
                'cu': [u'Польꙃєватєл҄ь', u'Участник', u'Польѕевател҄ь'],
                'cv': [u'Хутшăнакан', u'Участница'],
                'cy': u'Defnyddiwr',
                'da': u'Bruger',
                'de': [u'Benutzer', u'Benutzerin'],
                'dsb': [u'Wužywaŕ', u'Benutzer', u'Benutzerin'],
                'dv': u'މެމްބަރު',
                'el': u'Χρήστης',
                'eml': u'Utente',
                ...
                'haw': u'Mea hoʻohana',
                'he': [u'משתמש', u'משתמשת'],
                'hi': [u'सदस्य', u'U', u'स', u'सवा'],
                'hr': u'Suradnik',
                'hsb': [u'Wužiwar', u'Benutzer', u'Benutzerin'],
                ...
                'krc': [u'Къошулуучу', u'Участница'],
                'ksh': [u'Metmaacher', u'Medmaacher', u'Benutzer', u'Benutzerin'],
                'ku': u'Bikarhêner',
                ...
                'lbe': [u'Гьуртту хьума', u'Участница'],
                'li': u'Gebroeker',
                'lij': u'Utente',
                ...
                'or': [u'ବ୍ୟବାହାରକାରୀ', u'ବ୍ୟବହାରକାରି'],
                'os': u'Архайæг',
                'pa': u'ਮੈਂਬਰ',
                'pcd': u'Utilisateur',
                ...
                'pnt': u'Χρήστες',
                'ps': [u'کارن', u'کارونکی'],
                'pt': [u'Usuário', u'Utilizador', u'Utilizadora'],
                ...
                'sk': u'Redaktor',
                'sl': u'Uporabnik',
                'sq': [u'Përdoruesi', u'Perdoruesi'],
                'sr': [u'Корисник', u'Korisnik'],
                'srn': [u'Masyin', u'Gebruiker'],
                'stq': [u'Benutser', u'Benutzer', u'Benutzerin'],
                'su': u'Pamaké',
                'sv': u'Användare',
                'sw': u'Mtumiaji',
                ...
                'yi': [u'באַניצער', u'באנוצער', u'באניצער', u'משתמשת'],
                'yo': u'Oníṣe',
                'za': u'用户',
                'zea': u'Gebruker',
                'zh': [u'User', u'用户', u'用戶'],
            ...
            3: {
                ...
                'ba': [u'Ҡатнашыусы м-н фекер алышыу', u'Обсуждение участницы'],
                ...
                'cs': [u'Diskuse s wikipedistou', u'Diskuse s uživatelem', u'Diskuse s wikipedistkou', u'Wikipedista diskuse', u'Wikipedistka diskuse', u'Diskuse s uživatelkou', u'Uživatel diskuse', u'Uživatelka diskuse'],
                'csb': [u'Diskùsëjô brëkòwnika', u'Dyskusja użytkownika', u'Dyskusja użytkowniczki'],
                'cu': [u'Польꙃєватєлꙗ бєсѣда', u'Польѕевател� бесѣда'],
                'cv': [u'Хутшăнаканăн канашлу страници', u'Обсуждение участницы'],
                'cy': u'Sgwrs Defnyddiwr',
                'da': u'Brugerdiskussion',
                'de': [u'Benutzer Diskussion', u'BD', u'Benutzerin Diskussion'],
                'dsb': [u'Diskusija wužywarja', u'Benutzer Diskussion', u'Benutzerin Diskussion'],
                ...
                'frp': [u'Discussion utilisator', u'Discussion Utilisator'],
                ...
                'hi': [u'सदस्य वार्ता', u'UT'],
                'hr': u'Razgovor sa suradnikom',
                'hsb': [u'Diskusija z wužiwarjom', u'Benutzer Diskussion', u'Benutzerin Diskussion'],
                ...
                'krc': [u'Къошулуучуну сюзюу', u'Обсуждение участницы'],
                ...
                'lbe': [u'Гьуртту хьуминнал ихтилат', u'Обсуждение участницы'],
                ...
                'myv': [u'Теицянь кортамось', u'Обсуждение участницы'],
                ...
                'or': [u'ବ୍ୟବାହାରକାରୀଙ୍କ ଆଲୋଚନା', u'ବ୍ୟବହାରକାରିଁକ ଆଲୋଚନା'],
                ...
                'pt': [u'Usuário Discussão', u'Utilizador Discussão', u'Utilizadora Discussão'],
                ...
                'sq': [u'Përdoruesi diskutim', u'Perdoruesi diskutim'],
                'sr': [u'Разговор са корисником', u'Razgovor sa korisnikom'],
                'srn': [u'Taki fu masyin', u'Overleg gebruiker'],
                'stq': [u'Benutser Diskussion', u'Benutzer Diskussion', u'Benutzerin Diskussion'],
                'su': u'Obrolan pamaké',
                ...
                'udm': [u'Викиавтор сярысь вераськон', u'Обсуждение участницы'],
                ...
                'yi': [u'באַניצער רעדן', u'באנוצער רעדן', u'באניצער רעדן', u'שיחת משתמשת'],
                'yo': u'Ọ̀rọ̀ oníṣe',
                'za': [u'用户讨论', u'用户对话'],
            ...
            7: {
                ...
                'zh-yue': [u'File talk', u'文件傾偈', u'檔 討論', u'档 讨论', u'檔案 討論', u'档案 讨论', u'圖 討論', u'图 讨论', u'圖像 討論', u'图像 讨论'],
            },
            8: {
            ...
            9: {
                ...
                'ro': [u'Discuție MediaWiki', u'Discuţie MediaWiki'],
                ...
                'zh': u'MediaWiki talk',
                'zh-yue': [u'MediaWiki talk', u'MediaWiki 傾偈'],
            },
            10: {
                '_default': u'Template',
            ...
            11: {
                ...
                'or': [u'ଟେମ୍ପଲେଟ ଆଲୋଚନା', u'ଟେଁପଲେଟ ଆଲୋଚନା'],
            ...
            13: {
                ...
                'nds-nl': [u'Overleg hulpe', u'Overleg help'],
                'ne': u'मद्दत वार्ता',
