...
class Family:
    def __init__(self):
        ...
        self.alphabetic = [
            ...
            'sw', 'koi', 'kv', 'kg', 'ht', 'ku', 'kj', 'lad', 'lbe', 'lo', 'la',
            'lv', 'lb', 'lt', 'lij', 'li', 'ln', 'jbo', 'lg', 'lmo', 'hu', 'mk',
            'mg', 'ml', 'mt', 'mi', 'mr', 'arz', 'mzn', 'ms', 'cdo', 'mwl',
            'mdf', 'mo', 'mn', 'mus', 'my', 'nah', 'na', 'fj', 'nl', 'nds-nl',
            'cr', 'ne', 'new', 'ja', 'nap', 'ce', 'frr', 'pih', 'no', 'nb',
            'nn', 'nrm', 'nov', 'ii', 'oc', 'mrj', 'mhr', 'or', 'om', 'ng',
            'hz', 'uz', 'pa', 'pi', 'pfl', 'pag', 'pnb', 'pap', 'ps', 'km',
            'pcd', 'pms', 'tpi', 'nds', 'pl', 'tokipona', 'tp', 'pnt', 'pt',
            'aa', 'kaa', 'crh', 'ty', 'ksh', 'ro', 'rmy', 'rm', 'qu', 'ru',
            'rue', 'sah', 'se', 'sm', 'sa', 'sg', 'sc', 'sco', 'stq', 'st',
            'tn', 'sq', 'scn', 'si', 'simple', 'sd', 'ss', 'sk', 'cu', 'sl',
            'szl', 'so', 'ckb', 'srn', 'sr', 'sh', 'su', 'fi', 'sv', 'tl', 'ta',
            'kab', 'roa-tara', 'tt', 'te', 'tet', 'th', 'ti', 'tg', 'to', 'chr',
            'chy', 've', 'tr', 'tk', 'tw', 'udm', 'bug', 'uk', 'ur', 'ug', 'za',
            'vec', 'vi', 'vo', 'fiu-vro', 'wa', 'zh-classical', 'vls', 'war',
        ...
        self.alphabetic_revised = [
            ...
            'lad', 'lbe', 'lo', 'la', 'lv', 'to', 'lb', 'lt', 'lij', 'li', 'ln',
            'jbo', 'lg', 'lmo', 'hu', 'mk', 'mg', 'ml', 'krc', 'mt', 'mi', 'mr',
            'arz', 'mzn', 'cdo', 'mwl', 'koi', 'mdf', 'mo', 'mn', 'mus', 'my',
            'nah', 'fj', 'nl', 'nds-nl', 'cr', 'ne', 'new', 'ja', 'nap', 'ce',
            'frr', 'pih', 'no', 'nb', 'nn', 'nrm', 'nov', 'ii', 'oc', 'mhr',
            'or', 'om', 'ng', 'hz', 'uz', 'pa', 'pi', 'pfl', 'pag', 'pnb',
            'pap', 'ps', 'km', 'pcd', 'pms', 'nds', 'pl', 'pnt', 'pt', 'aa',
            'kaa', 'crh', 'ty', 'ksh', 'ro', 'rmy', 'rm', 'qu', 'ru', 'rue',
        ...
        self.namespaces = {
            ...
            3: {
                ...
                'ce': [u'Дийцаре декъашхо', u'Юзери дийца'],
                ...
                'eo': [u'Uzanto-Diskuto', u'Vikipediista diskuto',
                       u'Uzula diskuto', u'Uzanta diskuto'],
                ...
                'mr': u'सदस्य चर्चा',
                'mrj': [u'Сирӹшӹн кӓнгӓшӹмӓшӹжӹ', u'Обсуждение участницы'],
            ...
            7: {
                ...
                'ce': [u'Дийцаре хlуман', u'Сурти дийца'],
                ...
                'mr': u'चित्र चर्चा',
                'mrj': [u'Файл кӓнгӓшӹмӓш', u'Обсуждение изображения'],
            ...
            9: {
                ...
                'ce': [u'MediaWiki Дийцаре', u'МедйаВики дийца'],
                ...
                'eo': [u'MediaWiki-Diskuto', u'MediaWiki diskuto',
                       u'MediaVikia diskuto'],
