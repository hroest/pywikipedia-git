...
msg_change={
    ...
    'el': u'Robot: Αλλάζοντας %(oldcat)sες',
    ...
    'sr-el': u'Robot: menjanje %(oldcat)s',
...
deletion_reason_move = {
    ...
    'bn': u'বট: বিষয়শ্রেণী [[:বিষয়শ্রেণী:%(newcat)s|%(title)s]]-এ স্থানান্তরিত হয়েছে',
    ...
    'el': u'Bot: Η κατηγορία μετακινείθηκε στο [[:Κατηγορία:%(newcat)s|%(title)s]]',
    ...
    'ja': u'ロボットによる: カテゴリ [[:Category:%(newcat)]]へ移動',
    ...
    'pt': u'Bot: Categoria [[:Category:%(newcat)s|%(title)s]] foi movida',
    ...
    'sr-el': u'Robot: kategorija je premeštena u [[:Category:%(newcat)s|%(title)s]]',
    ...
    'zh-hans': u'机器人： 类别移动到 [[:Category:%(newcat)s|%(title)]]',
    }
...
class CategoryListifyRobot:
    ...
    listify_msg={
        ...
        'ar': u'روبوت: عرض من %(fromcat)s (%(num)d مدخلة)',
        ...
        'el': u'Bot: Καταλογίζοντας από %(fromcat)s (%(num)d entries)',
        ...
        'pt': u'Bot: Listando de %(fromcat)s (%(num)d entradas)',
        'ru': u'Робот: Составляется список из (%(num)d элементов) %(fromcat)',
        'sr': u'Робот: сврставање из %(fromcat)s (%(num)d entries)',
        'sr-el': u'Bot: svrstavanje iz %(fromcat)s (%(num)d entries)',
        ...
        'zh': u'機器人: 從%(fromcat)提取列表(%(num)d個項目)',
    }
...
class CategoryRemoveRobot:
    ...
    msg_remove={
        ...
        'kk': u'Бот: %(oldcat) дегеннен аластатты',
        'ksh': u'Bot: uß de %(oldcat) ußjedraare',
