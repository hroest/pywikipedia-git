...
msg_standalone = {
    ...
    'sr-ec': u'Робот: козметичке измене',
    'sr-el': u'Robot: kozmetičke izmene',
    ...
    'tt-cyrl': u'Робот: Косметик үзгәртүләр',
...
msg_append = {
    ...
    'be-tarask': u'; касмэтычныя зьмены',
    ...
    'sr-ec': u'; козметичке измене',
    'sr-el': u'; kozmetičke izmene',
