...
'pl': {
'redirect-fix-double': u'Robot naprawia podwójne przekierowanie → %(to)s',
'redirect-remove-broken': u'Robot: cel przekierowania nie istnieje',
},
'it': {
...
'redirect-remove-broken': u'ロボットによる:リダイレクトの目標は存在しませんでした',
},
'es': {
...
'pt': {
'redirect-fix-double': u'Bot: Corrigido duplo redirecionamento → %(to)s',
'redirect-remove-broken': u'Bot: Redirecionamento não existe',
},
'nl': {
'redirect-fix-double': u'Bot: dubbele doorverwijzing gecorrigeerd aan %(to)s',
'redirect-remove-broken': u'Bot: doelpagina doorverwijzing bestaat niet',
},
'ru': {
...
'no': {
'redirect-fix-double': u'bot: Retter dobbel omdirigering → %(to)s',
...
'ro': {
'redirect-fix-double': u'Robot: Corectarea dublu redirecţionare în %(to)s',
},
'tr': {
'redirect-fix-double': u'Bot değişikliği: Yönlendirmeye olan yönlendirme → %(to)s',
'redirect-remove-broken': u'Bot değişikliği: Var olmayan sayfaya olan yönlendirme',
},
'ko': {
...
'ar': {
'redirect-fix-double': u'روبوت: تصليح تحويلة مزدوجة → %(to)s',
...
'sr': {
'redirect-fix-double': u'Бот: Поправка дуплих преусмерења → %(to)s',
...
'redirect-broken-redirect-template': u'{{حذف سریع|بن بست}}',
},
'he': {
